...
* Read the [documentation](http://createjs.com/docs/easeljs/modules/EaselJS.html).
...
* Have a look at the included [examples](https://github.com/CreateJS/EaselJS/tree/master/examples) and [API documentation](http://createjs.com/docs/easeljs/modules/EaselJS.html) for more in-depth information.
...
The API is inspired in part by Flash's display list, and should be easy to pick up for both JS and AS3 developers. Check out the [docs](http://createjs.com/docs/easeljs/modules/EaselJS.html) for more information.
