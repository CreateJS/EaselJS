...
(function(){var b=function(){this.initialize()},a=b.prototype;b.initialize=function(d){d.addEventListener=a.addEventListener;d.removeEventListener=a.removeEventListener;d.removeAllEventListeners=a.removeAllEventListeners;d.hasEventListener=a.hasEventListener;d.dispatchEvent=a.dispatchEvent};a._listeners=null;a.initialize=function(){};a.addEventListener=function(d,a){var c=this._listeners;c||(c=this._listeners={});var b=c[d];b?this.removeEventListener(d,a):b=c[d]=[];b.push(a);return a};a.removeEventListener=
function(d,a){var c=this._listeners;if(c){var b=c[d];if(b)for(var f=0,g=b.length;f<g;f++)if(b[f]==a){1==g?delete c[d]:b.splice(f,1);break}}};a.removeAllEventListeners=function(d){d?this._listeners&&delete this._listeners[d]:this._listeners=null};a.dispatchEvent=function(d,a){var c=!1,b=this._listeners;if(d&&b){"string"==typeof d&&(d={type:d});d.target=a||this;b=b[d.type];if(!b)return c;for(var b=b.slice(),f=0,g=b.length;f<g;f++){var h=b[f];h instanceof Function?c=c||h.apply(null,[d]):h.handleEvent&&
(c=c||h.handleEvent(d))}}return!!c};a.hasEventListener=function(d){var a=this._listeners;return!(!a||!a[d])};a.toString=function(){return"[EventDispatcher]"};createjs.EventDispatcher=b})();this.createjs=this.createjs||{};
...
};a._updateTargetProps=function(a,j){var c,e,f,g;!a&&1==j?c=e=this._curQueueProps:(a.e&&(j=a.e(j,0,1,1)),c=a.p0,e=a.p1);for(n in this._initQueueProps){if(null==(f=c[n]))c[n]=f=this._initQueueProps[n];if(null==(g=e[n]))e[n]=g=f;f=f==g||0==j||1==j||"number"!=typeof f?1==j?g:f:f+(g-f)*j;var h=!1;if(g=b._plugins[n])for(var l=0,k=g.length;l<k;l++){var m=g[l].tween(this,n,f,c,e,j,!!a&&c==e,!a);m==b.IGNORE?h=!0:f=m}h||(this._target[n]=f)}};a._runActions=function(a,b,c){var e=a,f=b,g=-1,h=this._actions.length,
l=1;a>b&&(e=b,f=a,g=h,h=l=-1);for(;(g+=l)!=h;){b=this._actions[g];var k=b.t;(k==f||k>e&&k<f||c&&k==a)&&b.f.apply(b.o,b.p)}};a._appendQueueProps=function(a){var j,c,e,f,g,h;for(h in a){if(void 0===this._initQueueProps[h]){c=this._target[h];if(j=b._plugins[h]){e=0;for(f=j.length;e<f;e++)c=j[e].init(this,h,c)}this._initQueueProps[h]=void 0===c?null:c}else c=this._curQueueProps[h];if(j=b._plugins[h]){g=g||{};e=0;for(f=j.length;e<f;e++)j[e].step&&j[e].step(this,h,c,a[h],g)}this._curQueueProps[h]=a[h]}g&&
...
function(a){return 1-b.bounceOut(1-a)};b.bounceOut=function(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+0.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+0.9375:7.5625*(a-=2.625/2.75)*a+0.984375};b.bounceInOut=function(a){return 0.5>a?0.5*b.bounceIn(2*a):0.5*b.bounceOut(2*a-1)+0.5};b.getElasticIn=function(a,b){var j=2*Math.PI;return function(c){if(0==c||1==c)return c;var e=b/j*Math.asin(1/a);return-(a*Math.pow(2,10*(c-=1))*Math.sin((c-e)*j/b))}};b.elasticIn=b.getElasticIn(1,0.3);b.getElasticOut=
function(a,b){var j=2*Math.PI;return function(c){if(0==c||1==c)return c;var e=b/j*Math.asin(1/a);return a*Math.pow(2,-10*c)*Math.sin((c-e)*j/b)+1}};b.elasticOut=b.getElasticOut(1,0.3);b.getElasticInOut=function(a,b){var j=2*Math.PI;return function(c){var e=b/j*Math.asin(1/a);return 1>(c*=2)?-0.5*a*Math.pow(2,10*(c-=1))*Math.sin((c-e)*j/b):0.5*a*Math.pow(2,-10*(c-=1))*Math.sin((c-e)*j/b)+1}};b.elasticInOut=b.getElasticInOut(1,0.3*1.5);createjs.Ease=b})();(function(){var b=this.createjs=this.createjs||{},b=b.TweenJS=b.TweenJS||{};b.version="0.4.0";b.buildDate="Tue, 05 Feb 2013 22:18:05 GMT"})();
