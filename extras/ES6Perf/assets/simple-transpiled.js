...
var TranspiledSimple = function () {
  ...
  _createClass(TranspiledSimple, [{
    ...
    key: "inheritTest",
    value: function inheritTest() {}
  }]);

  return TranspiledSimple;
}();

var TranspiledExtended = function (_Simple) {
  _inherits(TranspiledExtended, _Simple);
  ...
  _createClass(TranspiledExtended, [{
    key: "superTest",
    value: function superTest() {
      _get(TranspiledExtended.prototype.__proto__ || Object.getPrototypeOf(TranspiledExtended.prototype), "superTest", this).call(this);
    }
  }, {
    key: "extendTest",
    value: function extendTest() {}
  }]);
