...
g.width;d.height=g.height;c._workingContext.drawImage(j.image,g.x,g.y,g.width,g.height,0,0,g.width,g.height);j=new Image;j.src=d.toDataURL("image/png");return j};c.mergeAlpha=function(b,a,c){c||(c=g.createCanvas?g.createCanvas():document.createElement("canvas"));c.width=Math.max(a.width,b.width);c.height=Math.max(a.height,b.height);var m=c.getContext("2d");m.save();m.drawImage(b,0,0);m.globalCompositeOperation="destination-in";m.drawImage(a,0,0);m.restore();return c};c._flip=function(b,a,j,g){for(var d=
