...
this._newPath();d=this._ctx.createLinearGradient(d,e,f,h);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",d],false)];return this};a.beginRadialGradientFill=function(a,b,d,e,f,h,i,l){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,h,i,l);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",d],false)];return this};a.beginBitmapFill=function(a,b){this._active&&this._newPath();
...
e,f,h,i,l){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,h,i,l);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.beginBitmapStroke=function(a,b){this._active&&this._newPath();var d=this._ctx.createPattern(a,b||"");this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.endStroke=function(){this.beginStroke();return this};a.curveTo=a.quadraticCurveTo;a.drawRect=
a.rect;a.drawRoundRect=function(a,b,c,e,f){this.drawRoundRectComplex(a,b,c,e,f,f,f,f);return this};a.drawRoundRectComplex=function(a,b,d,e,f,h,i,l){var k=(d<e?d:e)/2,g=0,m=0,q=0,r=0;f<0&&(f*=g=-1);f>k&&(f=k);h<0&&(h*=m=-1);h>k&&(h=k);i<0&&(i*=q=-1);i>k&&(i=k);l<0&&(l*=r=-1);l>k&&(l=k);this._dirty=this._active=true;var k=this._ctx.arcTo,p=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[a+d-h,b]),new c(k,[a+d+h*m,b-h*m,a+d,b+h,h]),new c(p,[a+d,b+e-i]),new c(k,[a+d+i*q,b+e+i*q,
a+d-i,b+e,i]),new c(p,[a+l,b+e]),new c(k,[a-l*r,b+e+l*r,a,b+e-l,l]),new c(p,[a,b+f]),new c(k,[a-f*g,b-f*g,a+f,b,f]),new c(this._ctx.closePath));return this};a.drawCircle=function(a,b,c){this.arc(a,b,c,0,Math.PI*2);return this};a.drawEllipse=function(a,b,d,e){this._dirty=this._active=true;var f=d/2*0.5522848,h=e/2*0.5522848,i=a+d,l=b+e,d=a+d/2,e=b+e/2;this._activeInstructions.push(new c(this._ctx.moveTo,[a,e]),new c(this._ctx.bezierCurveTo,[a,e-h,d-f,b,d,b]),new c(this._ctx.bezierCurveTo,[d+f,b,i,
e-h,i,e]),new c(this._ctx.bezierCurveTo,[i,e+h,d+f,l,d,l]),new c(this._ctx.bezierCurveTo,[d-f,l,a,e+h,a,e]));return this};a.drawPolyStar=function(a,b,d,e,f,h){this._dirty=this._active=true;f==null&&(f=0);f=1-f;h==null?h=0:h/=180/Math.PI;var i=Math.PI/e;this._activeInstructions.push(new c(this._ctx.moveTo,[a+Math.cos(h)*d,b+Math.sin(h)*d]));for(var l=0;l<e;l++)h+=i,f!=1&&this._activeInstructions.push(new c(this._ctx.lineTo,[a+Math.cos(h)*d*f,b+Math.sin(h)*d*f])),h+=i,this._activeInstructions.push(new c(this._ctx.lineTo,
[a+Math.cos(h)*d,b+Math.sin(h)*d]));return this};a.decodePath=function(a){for(var c=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],d=[2,2,4,6],e=0,f=a.length,h=[],i=0,l=0,k=b.BASE_64;e<f;){var g=k[a.charAt(e)],m=g>>3,q=c[m];if(!q||g&3)throw"bad path data";var r=d[m];m||(i=l=0);h.length=0;e++;g=(g>>2&1)+2;for(m=0;m<r;m++){var p=k[a.charAt(e)],s=p>>5?-1:1,p=(p&31)<<6|k[a.charAt(e+1)];g==3&&(p=p<<6|k[a.charAt(e+2)]);p=s*p/10;m%2?i=p+=i:l=p+=l;h[m]=p;e+=g}q.apply(this,h)}return this};
...
if(c==null)return null;c.invert();c.append(1,0,0,1,a,b);return new g.Point(c.tx,c.ty)};b.localToLocal=function(a,b,c){a=this.localToGlobal(a,b);return c.globalToLocal(a.x,a.y)};b.setTransform=function(a,b,c,d,e,f,h,i,l){this.x=a||0;this.y=b||0;this.scaleX=c==null?1:c;this.scaleY=d==null?1:d;this.rotation=e||0;this.skewX=f||0;this.skewY=h||0;this.regX=i||0;this.regY=l||0};b.getMatrix=function(a){return(a?a.identity():new g.Matrix2D).appendTransform(this.x,this.y,this.scaleX,this.scaleY,this.rotation,
...
c._tick&&c._tick(a)}if(this.onTick)this.onTick(a)};b._getObjectsUnderPoint=function(a,b,n,d){var e=createjs.DisplayObject._hitTestContext,f=createjs.DisplayObject._hitTestCanvas,h=this._matrix,i=d&1&&(this.onPress||this.onClick||this.onDoubleClick)||d&2&&(this.onMouseOver||this.onMouseOut);if(this.cacheCanvas&&i&&(this.getConcatenatedMatrix(h),e.setTransform(h.a,h.b,h.c,h.d,h.tx-a,h.ty-b),e.globalAlpha=h.alpha,this.draw(e),this._testHit(e)))return f.width=0,f.width=1,this;for(var l=this.children.length-
1;l>=0;l--){var k=this.children[l];if(k.isVisible()&&k.mouseEnabled)if(k instanceof c)if(i){if(k=k._getObjectsUnderPoint(a,b))return this}else{if(k=k._getObjectsUnderPoint(a,b,n,d),!n&&k)return k}else if(!d||i||d&1&&(k.onPress||k.onClick||k.onDoubleClick)||d&2&&(k.onMouseOver||k.onMouseOut)){var g=k.hitArea;k.getConcatenatedMatrix(h);g&&(h.appendTransform(g.x+k.regX,g.y+k.regY,g.scaleX,g.scaleY,g.rotation,g.skewX,g.skewY,g.regX,g.regY),h.alpha*=g.alpha/k.alpha);e.globalAlpha=h.alpha;e.setTransform(h.a,
h.b,h.c,h.d,h.tx-a,h.ty-b);(g||k).draw(e);if(this._testHit(e))if(f.width=0,f.width=1,i)return this;else if(n)n.push(k);else return k}}return null};g.Container=c})(createjs||(createjs={}));(function(g){var c=function(a){this.initialize(a)},b=c.prototype=new g.Container;c._snapToPixelEnabled=false;b.autoClear=true;b.canvas=null;b.mouseX=null;b.mouseY=null;b.onMouseMove=null;b.onMouseUp=null;b.onMouseDown=null;b.snapToPixelEnabled=false;b.mouseInBounds=false;b.tickOnUpdate=true;b._pointerData=null;b._pointerCount=0;b._primaryPointerID=null;b._mouseOverIntervalID=null;b.Container_initialize=b.initialize;b.initialize=function(a){this.Container_initialize();this.canvas=a instanceof HTMLCanvasElement?
...
b){b||(b="image/png");var c=this.canvas.getContext("2d"),d=this.canvas.width,e=this.canvas.height,f;if(a){f=c.getImageData(0,0,d,e);var h=c.globalCompositeOperation;c.globalCompositeOperation="destination-over";c.fillStyle=a;c.fillRect(0,0,d,e)}var i=this.canvas.toDataURL(b);if(a)c.clearRect(0,0,d,e),c.putImageData(f,0,0),c.globalCompositeOperation=h;return i};b.enableMouseOver=function(a){if(this._mouseOverIntervalID)clearInterval(this._mouseOverIntervalID),this._mouseOverIntervalID=null;if(a==null)a=
...
this.outline;a.lineHeight=this.lineHeight;a.lineWidth=this.lineWidth};b._getWorkingContext=function(){var a=c._workingContext;a.font=this.font;a.textAlign=this.textAlign||"start";a.textBaseline=this.textBaseline||"alphabetic";return a};b._drawText=function(a){var b=!!a;b||(a=this._getWorkingContext());for(var c=String(this.text).split(/(?:\r\n|\r|\n)/),d=this.lineHeight||this.getMeasuredLineHeight(),e=0,f=0,h=c.length;f<h;f++){var i=a.measureText(c[f]).width;if(this.lineWidth==null||i<this.lineWidth)b&&
this._drawTextLine(a,c[f],e*d);else{for(var i=c[f].split(/(\s)/),g=i[0],k=1,o=i.length;k<o;k+=2)a.measureText(g+i[k]+i[k+1]).width>this.lineWidth?(b&&this._drawTextLine(a,g,e*d),e++,g=i[k+1]):g+=i[k]+i[k+1];b&&this._drawTextLine(a,g,e*d)}e++}return e};b._drawTextLine=function(a,b,c){this.outline?a.strokeText(b,0,c,this.maxWidth||65535):a.fillText(b,0,c,this.maxWidth||65535)};g.Text=c})(createjs||(createjs={}));(function(g){var c=function(){throw"SpriteSheetUtils cannot be instantiated";};c._workingCanvas=document.createElement("canvas");c._workingContext=c._workingCanvas.getContext("2d");c.addFlippedFrames=function(b,a,j,g){if(a||j||g){var d=0;a&&c._flip(b,++d,true,false);j&&c._flip(b,++d,false,true);g&&c._flip(b,++d,true,true)}};c.extractFrame=function(b,a){isNaN(a)&&(a=b.getAnimation(a).frames[0]);var j=b.getFrame(a);if(!j)return null;var g=j.rect,d=c._workingCanvas;d.width=g.width;d.height=g.height;
c._workingContext.drawImage(j.image,g.x,g.y,g.width,g.height,0,0,g.width,g.height);j=new Image;j.src=d.toDataURL("image/png");return j};c._flip=function(b,a,j,g){for(var d=b._images,e=c._workingCanvas,f=c._workingContext,h=d.length/a,i=0;i<h;i++){var l=d[i];l.__tmp=i;e.width=l.width;e.height=l.height;f.setTransform(j?-1:1,0,0,g?-1:1,j?l.width:0,g?l.height:0);f.drawImage(l,0,0);var k=new Image;k.src=e.toDataURL("image/png");k.width=l.width;k.height=l.height;d.push(k)}f=b._frames;e=f.length/a;for(i=
0;i<e;i++){var l=f[i],o=l.rect.clone(),k=d[l.image.__tmp+h*a],m={image:k,rect:o,regX:l.regX,regY:l.regY};if(j)o.x=k.width-o.x-o.width,m.regX=o.width-l.regX;if(g)o.y=k.height-o.y-o.height,m.regY=o.height-l.regY;f.push(m)}j="_"+(j?"h":"")+(g?"v":"");g=b._animations;b=b._data;d=g.length/a;for(i=0;i<d;i++){f=g[i];l=b[f];h={name:f+j,frequency:l.frequency,next:l.next,frames:[]};l.next&&(h.next+=j);f=l.frames;l=0;for(k=f.length;l<k;l++)h.frames.push(f[l]+e*a);b[h.name]=h;g.push(h.name)}};g.SpriteSheetUtils=
...
f=this.maxHeight-b,h=1,i=0,l=a.length-1;l>=0;l--){var k=a[l],o=this._scale*k.scale,m=k.sourceRect,q=k.source,r=Math.floor(o*m.x-1),p=Math.floor(o*m.y-1),s=Math.ceil(o*m.height),m=Math.ceil(o*m.width);if(m>e)throw c.ERR_DIMENSIONS;if(!(s>f||h+m>e))k.img=n,k.rect=new g.Rectangle(h,b,m,s),i=i||s,a.splice(l,1),d[k.index]=[h-1,b-1,m+2,s+2,n,Math.round(-r+o*q.regX),Math.round(-p+o*q.regY)],h+=m+2}return{w:h,h:i}};b._endBuild=function(){this.spriteSheet=new g.SpriteSheet(this._data);this._data=null;this._callback&&
