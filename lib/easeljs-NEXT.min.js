...
return this};a.beginLinearGradientFill=function(a,b,d,e,f,h){this._active&&this._newPath();d=this._ctx.createLinearGradient(d,e,f,h);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",d],false)];return this};a.beginRadialGradientFill=function(a,b,d,e,f,h,i,j){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,h,i,j);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",
...
["strokeStyle",d],false)];return this};a.beginRadialGradientStroke=function(a,b,d,e,f,h,i,j){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,h,i,j);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.beginBitmapStroke=function(a,b){this._active&&this._newPath();var d=this._ctx.createPattern(a,b||"");this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.endStroke=
function(){this.beginStroke();return this};a.curveTo=a.quadraticCurveTo;a.drawRect=a.rect;a.drawRoundRect=function(a,b,c,e,f){this.drawRoundRectComplex(a,b,c,e,f,f,f,f);return this};a.drawRoundRectComplex=function(a,b,d,e,f,h,i,j){var l=(d<e?d:e)/2,g=0,p=0,o=0,r=0;f<0&&(f*=g=-1);f>l&&(f=l);h<0&&(h*=p=-1);h>l&&(h=l);i<0&&(i*=o=-1);i>l&&(i=l);j<0&&(j*=r=-1);j>l&&(j=l);this._dirty=this._active=true;var l=this._ctx.arcTo,q=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[a+d-h,b]),
new c(l,[a+d+h*p,b-h*p,a+d,b+h,h]),new c(q,[a+d,b+e-i]),new c(l,[a+d+i*o,b+e+i*o,a+d-i,b+e,i]),new c(q,[a+j,b+e]),new c(l,[a-j*r,b+e+j*r,a,b+e-j,j]),new c(q,[a,b+f]),new c(l,[a-f*g,b-f*g,a+f,b,f]),new c(this._ctx.closePath));return this};a.drawCircle=function(a,b,c){this.arc(a,b,c,0,Math.PI*2);return this};a.drawEllipse=function(a,b,d,e){this._dirty=this._active=true;var f=d/2*0.5522848,h=e/2*0.5522848,i=a+d,j=b+e,d=a+d/2,e=b+e/2;this._activeInstructions.push(new c(this._ctx.moveTo,[a,e]),new c(this._ctx.bezierCurveTo,
[a,e-h,d-f,b,d,b]),new c(this._ctx.bezierCurveTo,[d+f,b,i,e-h,i,e]),new c(this._ctx.bezierCurveTo,[i,e+h,d+f,j,d,j]),new c(this._ctx.bezierCurveTo,[d-f,j,a,e+h,a,e]));return this};a.drawPolyStar=function(a,b,d,e,f,h){this._dirty=this._active=true;f==null&&(f=0);f=1-f;h==null?h=0:h/=180/Math.PI;var i=Math.PI/e;this._activeInstructions.push(new c(this._ctx.moveTo,[a+Math.cos(h)*d,b+Math.sin(h)*d]));for(var j=0;j<e;j++)h+=i,f!=1&&this._activeInstructions.push(new c(this._ctx.lineTo,[a+Math.cos(h)*d*
f,b+Math.sin(h)*d*f])),h+=i,this._activeInstructions.push(new c(this._ctx.lineTo,[a+Math.cos(h)*d,b+Math.sin(h)*d]));return this};a.decodePath=function(a){for(var c=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],d=[2,2,4,6],e=0,f=a.length,h=[],i=0,j=0,l=b.BASE_64;e<f;){var g=a.charAt(e),p=l[g],o=p>>3,r=c[o];if(!r||p&3)throw"bad path data (@"+e+"): "+g;g=d[o];o||(i=j=0);h.length=0;e++;p=(p>>2&1)+2;for(o=0;o<g;o++){var q=l[a.charAt(e)],t=q>>5?-1:1,q=(q&31)<<6|l[a.charAt(e+1)];p==
3&&(q=q<<6|l[a.charAt(e+2)]);q=t*q/10;o%2?i=q+=i:j=q+=j;h[o]=q;e+=p}r.apply(this,h)}return this};a.clone=function(){var a=new b;a._instructions=this._instructions.slice();a._activeInstructions=this._activeInstructions.slice();a._oldInstructions=this._oldInstructions.slice();if(this._fillInstructions)a._fillInstructions=this._fillInstructions.slice();if(this._strokeInstructions)a._strokeInstructions=this._strokeInstructions.slice();if(this._strokeStyleInstructions)a._strokeStyleInstructions=this._strokeStyleInstructions.slice();
...
this._drawTextLine(a,c[f],e*d);else{for(var g=c[f].split(/(\s)/),j=g[0],l=1,n=g.length;l<n;l+=2)a.measureText(j+g[l]+g[l+1]).width>this.lineWidth?(b&&this._drawTextLine(a,j,e*d),e++,j=g[l+1]):j+=g[l]+g[l+1];b&&this._drawTextLine(a,j,e*d)}e++}return e};b._drawTextLine=function(a,b,c){this.outline?a.strokeText(b,0,c,this.maxWidth||65535):a.fillText(b,0,c,this.maxWidth||65535)};g.Text=c})(createjs||(createjs={}));(function(g){var c=function(){throw"SpriteSheetUtils cannot be instantiated";};c._workingCanvas=g.createCanvas?g.createCanvas():document.createElement("canvas");c._workingContext=c._workingCanvas.getContext("2d");c.addFlippedFrames=function(b,a,k,g){if(a||k||g){var d=0;a&&c._flip(b,++d,true,false);k&&c._flip(b,++d,false,true);g&&c._flip(b,++d,true,true)}};c.extractFrame=function(b,a){isNaN(a)&&(a=b.getAnimation(a).frames[0]);var k=b.getFrame(a);if(!k)return null;var g=k.rect,d=c._workingCanvas;d.width=
g.width;d.height=g.height;c._workingContext.drawImage(k.image,g.x,g.y,g.width,g.height,0,0,g.width,g.height);k=new Image;k.src=d.toDataURL("image/png");return k};c.mergeAlpha=function(b,a,c){c||(c=g.createCanvas?g.createCanvas():document.createElement("canvas"));c.width=Math.max(a.width,b.width);c.height=Math.max(a.height,b.height);var m=c.getContext("2d");m.save();m.drawImage(b,0,0);m.globalCompositeOperation="destination-in";m.drawImage(a,0,0);m.restore();return c};c._flip=function(b,a,k,g){for(var d=
b._images,e=c._workingCanvas,f=c._workingContext,h=d.length/a,i=0;i<h;i++){var j=d[i];j.__tmp=i;e.width=0;e.width=j.width;e.height=j.height;f.setTransform(k?-1:1,0,0,g?-1:1,k?j.width:0,g?j.height:0);f.drawImage(j,0,0);var l=new Image;l.src=e.toDataURL("image/png");l.width=j.width;l.height=j.height;d.push(l)}f=b._frames;e=f.length/a;for(i=0;i<e;i++){var j=f[i],n=j.rect.clone(),l=d[j.image.__tmp+h*a],p={image:l,rect:n,regX:j.regX,regY:j.regY};if(k)n.x=l.width-n.x-n.width,p.regX=n.width-j.regX;if(g)n.y=
l.height-n.y-n.height,p.regY=n.height-j.regY;f.push(p)}k="_"+(k?"h":"")+(g?"v":"");g=b._animations;b=b._data;d=g.length/a;for(i=0;i<d;i++){f=g[i];j=b[f];h={name:f+k,frequency:j.frequency,next:j.next,frames:[]};j.next&&(h.next+=k);f=j.frames;j=0;for(l=f.length;j<l;j++)h.frames.push(f[j]+e*a);b[h.name]=h;g.push(h.name)}};g.SpriteSheetUtils=c})(createjs||(createjs={}));(function(g){var c=function(){this.initialize()},b=c.prototype;c.ERR_DIMENSIONS="frame dimensions exceed max spritesheet dimensions";c.ERR_RUNNING="a build is already running";b.maxWidth=2048;b.maxHeight=2048;b.spriteSheet=null;b.scale=1;b.padding=1;b._frames=null;b._animations=null;b._data=null;b._nextFrameIndex=0;b._index=0;b._callback=null;b._timeSlice=null;b._timerID=null;b._scale=1;b.initialize=function(){this._frames=[];this._animations={}};b.addFrame=function(a,b,g,d,e,f){if(this._data)throw c.ERR_RUNNING;
...
for(var b=a.timeline.duration,f=0;f<b;f++)this.addFrame(a,d&&d[f]?d[f]:e,g,function(a){var b=this.actionsEnabled;this.actionsEnabled=false;this.gotoAndStop(a);this.actionsEnabled=b},[f],a);var f=a.timeline._labels,a=[],h;for(h in f)a.push({index:f[h],label:h});if(a.length){a.sort(function(a,b){return a.index-b.index});f=0;for(h=a.length;f<h;f++){for(var g=a[f].label,d=f==h-1?b:a[f+1].index,e=[],i=a[f].index;i<d;i++)e.push(i);this.addAnimation(g,e,true)}}};b.build=function(){if(this._data)throw c.ERR_RUNNING;
...
b._startBuild=function(){var a=this.padding||0;this.spriteSheet=null;this._index=0;this._scale=this.scale;var b=[];this._data={images:[],frames:b,animations:this._animations};var m=this._frames.slice();m.sort(function(a,b){return a.height<=b.height?-1:1});if(m[m.length-1].height+a*2>this.maxHeight)throw c.ERR_DIMENSIONS;for(var d=0,e=0,f=0;m.length;){var h=this._fillRow(m,d,f,b,a);if(h.w>e)e=h.w;d+=h.h;if(!h.h||!m.length){var i=g.createCanvas?g.createCanvas():document.createElement("canvas");i.width=
this._getSize(e,this.maxWidth);i.height=this._getSize(d,this.maxHeight);this._data.images[f]=i;h.h||(e=d=0,f++)}}};b._getSize=function(a,b){for(var c=4;Math.pow(2,++c)<a;);return Math.min(b,Math.pow(2,c))};b._fillRow=function(a,b,m,d,e){var f=this.maxWidth,h=this.maxHeight-b,i=e;b+=e;for(var j=0,l=a.length-1;l>=0;l--){var n=a[l],p=this._scale*n.scale,o=n.sourceRect,r=n.source,q=Math.floor(p*o.x-e),t=Math.floor(p*o.y-e),s=Math.ceil(p*o.height+e*2),o=Math.ceil(p*o.width+e*2);if(o>f)throw c.ERR_DIMENSIONS;
if(!(s>h||i+o>f))n.img=m,n.rect=new g.Rectangle(i,b,o,s),j=j||s,a.splice(l,1),d[n.index]=[i,b,o,s,m,Math.round(-q+p*r.regX-e),Math.round(-t+p*r.regY-e)],i+=o}return{w:i,h:j}};b._endBuild=function(){this.spriteSheet=new g.SpriteSheet(this._data);this._data=null;this._callback&&this._callback(this)};b._run=function(){for(var a=(new Date).getTime()+this._timeSlice,b=false;a>(new Date).getTime();)if(!this._drawNext()){b=true;break}if(b)this._endBuild();else{var c=this;this._timerID=setTimeout(function(){c._run()},
