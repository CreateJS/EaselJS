...
1).data[3]>1}catch(m){if(!c.suppressCrossDomainErrors)throw"An error has occurred. This is most likely due to security restrictions on reading canvas pixel data with local or cross-domain images.";}return b};b._applyFilters=function(){if(this.filters&&this.filters.length!=0&&this.cacheCanvas)for(var a=this.filters.length,b=this.cacheCanvas.getContext("2d"),c=this.cacheCanvas.width,d=this.cacheCanvas.height,e=0;e<a;e++)this.filters[e].applyFilter(b,0,0,c,d)};g.DisplayObject=c})(createjs||(createjs=
...
this.localToGlobal(a,b);this._getObjectsUnderPoint(d.x,d.y,c);return c};b.getObjectUnderPoint=function(a,b){var c=this.localToGlobal(a,b);return this._getObjectsUnderPoint(c.x,c.y)};b.clone=function(a){var b=new c;this.cloneProps(b);if(a)for(var m=b.children=[],d=0,e=this.children.length;d<e;d++){var f=this.children[d].clone(a);f.parent=b;m.push(f)}return b};b.toString=function(){return"[Container (name="+this.name+")]"};b.DisplayObject__tick=b._tick;b._tick=function(a){for(var b=this.children.length-
1;b>=0;b--){var c=this.children[b];c._tick&&c._tick(a)}this.DisplayObject__tick(a)};b._getObjectsUnderPoint=function(a,b,m,d){var e=createjs.DisplayObject._hitTestContext,f=createjs.DisplayObject._hitTestCanvas,h=this._matrix,k=d&1&&(this.onPress||this.onClick||this.onDoubleClick)||d&2&&(this.onMouseOver||this.onMouseOut);if(this.cacheCanvas&&k&&(this.getConcatenatedMatrix(h),e.setTransform(h.a,h.b,h.c,h.d,h.tx-a,h.ty-b),e.globalAlpha=h.alpha,this.draw(e),this._testHit(e)))return f.width=0,f.width=
1,this;for(var i=this.children.length-1;i>=0;i--){var g=this.children[i];if(g.isVisible()&&g.mouseEnabled)if(g instanceof c)if(k){if(g=g._getObjectsUnderPoint(a,b))return this}else{if(g=g._getObjectsUnderPoint(a,b,m,d),!m&&g)return g}else if(!d||k||d&1&&(g.onPress||g.onClick||g.onDoubleClick)||d&2&&(g.onMouseOver||g.onMouseOut)){var n=g.hitArea;g.getConcatenatedMatrix(h);n&&(h.appendTransform(n.x+g.regX,n.y+g.regY,n.scaleX,n.scaleY,n.rotation,n.skewX,n.skewY,n.regX,n.regY),h.alpha*=n.alpha/g.alpha);
e.globalAlpha=h.alpha;e.setTransform(h.a,h.b,h.c,h.d,h.tx-a,h.ty-b);(n||g).draw(e);if(this._testHit(e))if(f.width=0,f.width=1,k)return this;else if(m)m.push(g);else return g}}return null};g.Container=c})(createjs||(createjs={}));(function(g){var c=function(a){this.initialize(a)},b=c.prototype=new g.Container;c._snapToPixelEnabled=false;b.autoClear=true;b.canvas=null;b.mouseX=0;b.mouseY=0;b.onMouseMove=null;b.onMouseUp=null;b.onMouseDown=null;b.snapToPixelEnabled=false;b.mouseInBounds=false;b.tickOnUpdate=true;b.mouseMoveOutside=false;b._pointerData=null;b._pointerCount=0;b._primaryPointerID=null;b._mouseOverIntervalID=null;b.Container_initialize=b.initialize;b.initialize=function(a){this.Container_initialize();this.canvas=
...
b._images,e=c._workingCanvas,f=c._workingContext,h=d.length/a,k=0;k<h;k++){var i=d[k];i.__tmp=k;e.width=0;e.width=i.width;e.height=i.height;f.setTransform(j?-1:1,0,0,g?-1:1,j?i.width:0,g?i.height:0);f.drawImage(i,0,0);var l=new Image;l.src=e.toDataURL("image/png");l.width=i.width;l.height=i.height;d.push(l)}f=b._frames;e=f.length/a;for(k=0;k<e;k++){var i=f[k],n=i.rect.clone(),l=d[i.image.__tmp+h*a],o={image:l,rect:n,regX:i.regX,regY:i.regY};if(j)n.x=l.width-n.x-n.width,o.regX=n.width-i.regX;if(g)n.y=
