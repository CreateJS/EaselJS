...
1&&c._tick()};c._handleTimeout=function(){c.timeoutID=null;c._setupTick();c._tick()};c._setupTick=function(){if(!(c._rafActive||c.timeoutID!=null)){if(c.useRAF){var a=g.requestAnimationFrame||g.webkitRequestAnimationFrame||g.mozRequestAnimationFrame||g.oRequestAnimationFrame||g.msRequestAnimationFrame;if(a){a(c._handleAF,c.animationTarget);c._rafActive=true;return}}c.timeoutID=setTimeout(c._handleTimeout,c._interval)}};c._tick=function(){c._ticks++;var a=c._getTime(),b=a-c._lastTime,p=c._paused;p&&
(c._pausedTickers++,c._pausedTime+=b);c._lastTime=a;for(var i=c._pauseable,e=c._listeners.slice(),d=e?e.length:0,f=0;f<d;f++){var h=e[f];h==null||p&&i[f]||(h.tick?h.tick(b,p):h instanceof Function&&h(b,p))}for(c._tickTimes.unshift(c._getTime()-a);c._tickTimes.length>100;)c._tickTimes.pop();for(c._times.unshift(a);c._times.length>100;)c._times.pop()};c._getTime=function(){return(new Date).getTime()};g.Ticker=c})(window);(function(g){var c=function(b,p,a,c,d){this.initialize(b,p,a,c,d)},a=c.prototype;a.stageX=0;a.stageY=0;a.type=null;a.nativeEvent=null;a.onMouseMove=null;a.onMouseUp=null;a.target=null;a.initialize=function(b,a,i,c,d){this.type=b;this.stageX=a;this.stageY=i;this.target=c;this.nativeEvent=d};a.clone=function(){return new c(this.type,this.stageX,this.stageY,this.target,this.nativeEvent)};a.toString=function(){return"[MouseEvent (type="+this.type+" stageX="+this.stageX+" stageY="+this.stageY+")]"};g.MouseEvent=
c})(window);(function(g){var c=function(b,a,i,c,d,f){this.initialize(b,a,i,c,d,f)},a=c.prototype;c.identity=null;c.DEG_TO_RAD=Math.PI/180;a.a=1;a.b=0;a.c=0;a.d=1;a.tx=0;a.ty=0;a.alpha=1;a.shadow=null;a.compositeOperation=null;a.initialize=function(b,a,i,c,d,f){if(b!=null)this.a=b;this.b=a||0;this.c=i||0;if(c!=null)this.d=c;this.tx=d||0;this.ty=f||0;return this};a.prepend=function(b,a,i,c,d,f){var h=this.tx;if(b!=1||a!=0||i!=0||c!=1){var l=this.a,k=this.c;this.a=l*b+this.b*i;this.b=l*a+this.b*c;this.c=k*b+this.d*
i;this.d=k*a+this.d*c}this.tx=h*b+this.ty*i+d;this.ty=h*a+this.ty*c+f;return this};a.append=function(b,a,i,c,d,f){var h=this.a,l=this.b,k=this.c,j=this.d;this.a=b*h+a*k;this.b=b*l+a*j;this.c=i*h+c*k;this.d=i*l+c*j;this.tx=d*h+f*k+this.tx;this.ty=d*l+f*j+this.ty;return this};a.prependMatrix=function(b){this.prepend(b.a,b.b,b.c,b.d,b.tx,b.ty);this.prependProperties(b.alpha,b.shadow,b.compositeOperation);return this};a.appendMatrix=function(b){this.append(b.a,b.b,b.c,b.d,b.tx,b.ty);this.appendProperties(b.alpha,
b.shadow,b.compositeOperation);return this};a.prependTransform=function(b,a,i,e,d,f,h,l,k){if(d%360)var j=d*c.DEG_TO_RAD,d=Math.cos(j),j=Math.sin(j);else d=1,j=0;if(l||k)this.tx-=l,this.ty-=k;f||h?(f*=c.DEG_TO_RAD,h*=c.DEG_TO_RAD,this.prepend(d*i,j*i,-j*e,d*e,0,0),this.prepend(Math.cos(h),Math.sin(h),-Math.sin(f),Math.cos(f),b,a)):this.prepend(d*i,j*i,-j*e,d*e,b,a);return this};a.appendTransform=function(b,a,i,e,d,f,h,l,k){if(d%360)var j=d*c.DEG_TO_RAD,d=Math.cos(j),j=Math.sin(j);else d=1,j=0;f||
h?(f*=c.DEG_TO_RAD,h*=c.DEG_TO_RAD,this.append(Math.cos(h),Math.sin(h),-Math.sin(f),Math.cos(f),b,a),this.append(d*i,j*i,-j*e,d*e,0,0)):this.append(d*i,j*i,-j*e,d*e,b,a);if(l||k)this.tx-=l*this.a+k*this.c,this.ty-=l*this.b+k*this.d;return this};a.rotate=function(b){var a=Math.cos(b),b=Math.sin(b),i=this.a,c=this.c,d=this.tx;this.a=i*a-this.b*b;this.b=i*b+this.b*a;this.c=c*a-this.d*b;this.d=c*b+this.d*a;this.tx=d*a-this.ty*b;this.ty=d*b+this.ty*a;return this};a.skew=function(b,a){b*=c.DEG_TO_RAD;a*=
c.DEG_TO_RAD;this.append(Math.cos(a),Math.sin(a),-Math.sin(b),Math.cos(b),0,0);return this};a.scale=function(b,a){this.a*=b;this.d*=a;this.tx*=b;this.ty*=a;return this};a.translate=function(b,a){this.tx+=b;this.ty+=a;return this};a.identity=function(){this.alpha=this.a=this.d=1;this.b=this.c=this.tx=this.ty=0;this.shadow=this.compositeOperation=null;return this};a.invert=function(){var b=this.a,a=this.b,i=this.c,c=this.d,d=this.tx,f=b*c-a*i;this.a=c/f;this.b=-a/f;this.c=-i/f;this.d=b/f;this.tx=(i*
this.ty-c*d)/f;this.ty=-(b*this.ty-a*d)/f;return this};a.isIdentity=function(){return this.tx==0&&this.ty==0&&this.a==1&&this.b==0&&this.c==0&&this.d==1};a.decompose=function(b){b==null&&(b={});b.x=this.tx;b.y=this.ty;b.scaleX=Math.sqrt(this.a*this.a+this.b*this.b);b.scaleY=Math.sqrt(this.c*this.c+this.d*this.d);var a=Math.atan2(-this.c,this.d),i=Math.atan2(this.b,this.a);a==i?(b.rotation=i/c.DEG_TO_RAD,this.a<0&&this.d>=0&&(b.rotation+=b.rotation<=0?180:-180),b.skewX=b.skewY=0):(b.skewX=a/c.DEG_TO_RAD,
b.skewY=i/c.DEG_TO_RAD);return b};a.reinitialize=function(b,a,i,c,d,f,h,l,k){this.initialize(b,a,i,c,d,f);this.alpha=h||1;this.shadow=l;this.compositeOperation=k;return this};a.appendProperties=function(b,a,i){this.alpha*=b;this.shadow=a||this.shadow;this.compositeOperation=i||this.compositeOperation;return this};a.prependProperties=function(b,a,i){this.alpha*=b;this.shadow=this.shadow||a;this.compositeOperation=this.compositeOperation||i;return this};a.clone=function(){var b=new c(this.a,this.b,
this.c,this.d,this.tx,this.ty);b.shadow=this.shadow;b.alpha=this.alpha;b.compositeOperation=this.compositeOperation;return b};a.toString=function(){return"[Matrix2D (a="+this.a+" b="+this.b+" c="+this.c+" d="+this.d+" tx="+this.tx+" ty="+this.ty+")]"};c.identity=new c(1,0,0,1,0,0);g.Matrix2D=c})(window);(function(g){var c=function(b,a){this.initialize(b,a)},a=c.prototype;a.x=0;a.y=0;a.initialize=function(b,a){this.x=b==null?0:b;this.y=a==null?0:a};a.clone=function(){return new c(this.x,this.y)};a.toString=function(){return"[Point (x="+this.x+" y="+this.y+")]"};g.Point=c})(window);(function(g){var c=function(b,a,i,c){this.initialize(b,a,i,c)},a=c.prototype;a.x=0;a.y=0;a.width=0;a.height=0;a.initialize=function(b,a,c,e){this.x=b==null?0:b;this.y=a==null?0:a;this.width=c==null?0:c;this.height=e==null?0:e};a.clone=function(){return new c(this.x,this.y,this.width,this.height)};a.toString=function(){return"[Rectangle (x="+this.x+" y="+this.y+" width="+this.width+" height="+this.height+")]"};g.Rectangle=c})(window);(function(g){var c=function(b,a,c,e){this.initialize(b,a,c,e)},a=c.prototype;c.identity=null;a.color=null;a.offsetX=0;a.offsetY=0;a.blur=0;a.initialize=function(b,a,c,e){this.color=b;this.offsetX=a;this.offsetY=c;this.blur=e};a.toString=function(){return"[Shadow]"};a.clone=function(){return new c(this.color,this.offsetX,this.offsetY,this.blur)};c.identity=new c("transparent",0,0,0);g.Shadow=c})(window);(function(g){var c=function(b){this.initialize(b)},a=c.prototype;a.complete=true;a.onComplete=null;a._animations=null;a._frames=null;a._images=null;a._data=null;a._loadCount=0;a._frameHeight=0;a._frameWidth=0;a._numFrames=0;a._regX=0;a._regY=0;a.initialize=function(b){var a,c,e;if(b!=null){if(b.images&&(c=b.images.length)>0){e=this._images=[];for(a=0;a<c;a++){var d=b.images[a];if(!(d instanceof Image)){var f=d,d=new Image;d.src=f}e.push(d);if(!d.getContext&&!d.complete)this._loadCount++,this.complete=
...
var e=this._ctx.createPattern(b,a||"");this._fillInstructions=[new c(this._setProp,["fillStyle",e],false)];return this};b.endFill=function(){return this.beginFill()};b.setStrokeStyle=function(b,i,e,d){this._active&&this._newPath();this._strokeStyleInstructions=[new c(this._setProp,["lineWidth",b==null?"1":b],false),new c(this._setProp,["lineCap",i==null?"butt":isNaN(i)?i:a.STROKE_CAPS_MAP[i]],false),new c(this._setProp,["lineJoin",e==null?"miter":isNaN(e)?e:a.STROKE_JOINTS_MAP[e]],false),new c(this._setProp,
...
b.rect;b.drawRoundRect=function(b,a,c,d,f){this.drawRoundRectComplex(b,a,c,d,f,f,f,f);return this};b.drawRoundRectComplex=function(b,a,e,d,f,h,l,k){this._dirty=this._active=true;var j=Math.PI,g=this._ctx.arc,m=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[b+f,a]),new c(m,[b+e-h,a]),h>=0?new c(g,[b+e-h,a+h,h,-j/2,0]):new c(g,[b+e,a,-h,j,j/2,true]),new c(m,[b+e,a+d-l]),k>=0?new c(g,[b+e-l,a+d-l,l,0,j/2]):new c(g,[b+e,a+d,-l,-j/2,j,true]),new c(m,[b+k,a+d]),k>=0?new c(g,[b+k,
a+d-k,k,j/2,j]):new c(g,[b,a+d,-k,0,-j/2,true]),new c(m,[b,a+f]),f>=0?new c(g,[b+f,a+f,f,j,-j/2]):new c(g,[b,a,-f,j/2,0,true]));return this};b.drawCircle=function(b,a,c){this.arc(b,a,c,0,Math.PI*2);return this};b.drawEllipse=function(b,a,e,d){this._dirty=this._active=true;var f=e/2*0.5522848,h=d/2*0.5522848,l=b+e,k=a+d,e=b+e/2,d=a+d/2;this._activeInstructions.push(new c(this._ctx.moveTo,[b,d]),new c(this._ctx.bezierCurveTo,[b,d-h,e-f,a,e,a]),new c(this._ctx.bezierCurveTo,[e+f,a,l,d-h,l,d]),new c(this._ctx.bezierCurveTo,
...
a+Math.sin(h)*e]));return this};b.decodePath=function(b){for(var c=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],e=[2,2,4,6],d=0,f=b.length,h=[],l=0,k=0,j=a.BASE_64;d<f;){var g=j[b.charAt(d)],m=g>>3,q=c[m];if(!q||g&3)throw"bad path data";var r=e[m];m||(l=k=0);h.length=0;d++;g=(g>>2&1)+2;for(m=0;m<r;m++){var o=j[b.charAt(d)],s=o>>5?-1:1,o=(o&31)<<6|j[b.charAt(d+1)];g==3&&(o=o<<6|j[b.charAt(d+2)]);o=s*o/10;m%2?l=o+=l:k=o+=k;h[m]=o;d+=g}q.apply(this,h)}return this};b.clone=function(){var b=
...
a.tx,a.ty);b.globalAlpha*=this.alpha;if(this.compositeOperation)b.globalCompositeOperation=this.compositeOperation;this.shadow&&this._applyShadow(b,this.shadow)};a.cache=function(b,a,i,e){var d=this.cacheCanvas;if(d==null)d=this.cacheCanvas=document.createElement("canvas");var f=d.getContext("2d");d.width=i;d.height=e;f.setTransform(1,0,0,1,-b,-a);f.clearRect(b,a,d.width,d.height);this.draw(f,true,this._matrix.reinitialize(1,0,0,1,-b,-a));this._cacheOffsetX=b;this._cacheOffsetY=a;this._applyFilters();
this.cacheID=c._nextCacheID++};a.updateCache=function(b){var a=this.cacheCanvas,i=this._cacheOffsetX,e=this._cacheOffsetY;if(a==null)throw"cache() must be called before updateCache()";var d=a.getContext("2d");d.setTransform(1,0,0,1,-i,-e);b?d.globalCompositeOperation=b:d.clearRect(i,e,a.width,a.height);this.draw(d,true);if(b)d.globalCompositeOperation="source-over";this._applyFilters();this.cacheID=c._nextCacheID++};a.uncache=function(){this._cacheDataURL=this.cacheCanvas=null;this.cacheID=this._cacheOffsetX=
...
if(c==null)return null;c.invert();c.append(1,0,0,1,b,a);return new Point(c.tx,c.ty)};a.localToLocal=function(b,a,c){b=this.localToGlobal(b,a);return c.globalToLocal(b.x,b.y)};a.setTransform=function(b,a,c,e,d,f,h,l,k){this.x=b||0;this.y=a||0;this.scaleX=c==null?1:c;this.scaleY=e==null?1:e;this.rotation=d||0;this.skewX=f||0;this.skewY=h||0;this.regX=l||0;this.regY=k||0};a.getMatrix=function(b){return(b?b.identity():new Matrix).appendTransform(this.x,this.y,this.scaleX,this.scaleY,this.rotation,this.skewX,
this.skewY,this.regX,this.regY).appendProperties(this.alpha,this.shadow,this.compositeOperation)};a.getConcatenatedMatrix=function(b){b?b.identity():b=new Matrix2D;for(var a=this;a!=null;)b.prependTransform(a.x,a.y,a.scaleX,a.scaleY,a.rotation,a.skewX,a.skewY,a.regX,a.regY).prependProperties(a.alpha,a.shadow,a.compositeOperation),a=a.parent;return b};a.hitTest=function(b,a){var i=c._hitTestContext,e=c._hitTestCanvas;i.setTransform(1,0,0,1,-b,-a);this.draw(i);i=this._testHit(i);e.width=0;e.width=1;
return i};a.clone=function(){var b=new c;this.cloneProps(b);return b};a.toString=function(){return"[DisplayObject (name="+this.name+")]"};a.cloneProps=function(b){b.alpha=this.alpha;b.name=this.name;b.regX=this.regX;b.regY=this.regY;b.rotation=this.rotation;b.scaleX=this.scaleX;b.scaleY=this.scaleY;b.shadow=this.shadow;b.skewX=this.skewX;b.skewY=this.skewY;b.visible=this.visible;b.x=this.x;b.y=this.y;b.mouseEnabled=this.mouseEnabled;b.compositeOperation=this.compositeOperation;if(this.cacheCanvas)b.cacheCanvas=
this.cacheCanvas.cloneNode(true),b.cacheCanvas.getContext("2d").putImageData(this.cacheCanvas.getContext("2d").getImageData(0,0,this.cacheCanvas.width,this.cacheCanvas.height),0,0)};a._applyShadow=function(b,a){a=a||Shadow.identity;b.shadowColor=a.color;b.shadowOffsetX=a.offsetX;b.shadowOffsetY=a.offsetY;b.shadowBlur=a.blur};a._tick=function(b){if(this.onTick)this.onTick(b)};a._testHit=function(b){try{var a=b.getImageData(0,0,1,1).data[3]>1}catch(i){if(!c.suppressCrossDomainErrors)throw"An error has occurred. This is most likely due to security restrictions on reading canvas pixel data with local or cross-domain images.";
...
f.updateContext(b),f.draw(b),b.restore())}return true};a.addChild=function(b){if(b==null)return b;var a=arguments.length;if(a>1){for(var c=0;c<a;c++)this.addChild(arguments[c]);return arguments[a-1]}b.parent&&b.parent.removeChild(b);b.parent=this;this.children.push(b);return b};a.addChildAt=function(b,a){var c=arguments.length;if(c>2){for(var a=arguments[e-1],e=0;e<c-1;e++)this.addChildAt(arguments[e],a+e);return arguments[c-2]}b.parent&&b.parent.removeChild(b);b.parent=this;this.children.splice(a,
0,b);return b};a.removeChild=function(b){var a=arguments.length;if(a>1){for(var c=true,e=0;e<a;e++)c=c&&this.removeChild(arguments[e]);return c}return this.removeChildAt(this.children.indexOf(b))};a.removeChildAt=function(b){var a=arguments.length;if(a>1){for(var c=[],e=0;e<a;e++)c[e]=arguments[e];c.sort(function(b,a){return a-b});for(var d=true,e=0;e<a;e++)d=d&&this.removeChildAt(c[e]);return d}if(b<0||b>this.children.length-1)return false;a=this.children[b];if(a!=null)a.parent=null;this.children.splice(b,
1);return true};a.removeAllChildren=function(){for(var b=this.children;b.length;)b.pop().parent=null};a.getChildAt=function(b){return this.children[b]};a.sortChildren=function(b){this.children.sort(b)};a.getChildIndex=function(b){return this.children.indexOf(b)};a.getNumChildren=function(){return this.children.length};a.swapChildrenAt=function(b,a){var c=this.children,e=c[b],d=c[a];e&&d&&(c[b]=d,c[a]=e)};a.swapChildren=function(b,a){for(var c=this.children,e,d,f=0,h=c.length;f<h;f++)if(c[f]==b&&(e=
f),c[f]==a&&(d=f),e!=null&&d!=null)break;f!=h&&(c[e]=a,c[d]=b)};a.setChildIndex=function(b,a){for(var c=this.children,e=0,d=c.length;e<d;e++)if(c[e]==b)break;e==d||a<0||a>d||e==a||(c.splice(a,1),a<e&&e--,c.splice(e,0,b))};a.contains=function(b){for(;b;){if(b==this)return true;b=b.parent}return false};a.hitTest=function(b,a){return this.getObjectUnderPoint(b,a)!=null};a.getObjectsUnderPoint=function(b,a){var c=[],e=this.localToGlobal(b,a);this._getObjectsUnderPoint(e.x,e.y,c);return c};a.getObjectUnderPoint=
function(b,a){var c=this.localToGlobal(b,a);return this._getObjectsUnderPoint(c.x,c.y)};a.clone=function(b){var a=new c;this.cloneProps(a);if(b)for(var i=a.children=[],e=0,d=this.children.length;e<d;e++){var f=this.children[e].clone(b);f.parent=a;i.push(f)}return a};a.toString=function(){return"[Container (name="+this.name+")]"};a._tick=function(b){for(var a=this.children.length-1;a>=0;a--){var c=this.children[a];c._tick&&c._tick(b)}if(this.onTick)this.onTick(b)};a._getObjectsUnderPoint=function(b,
a,i,e){var d=DisplayObject._hitTestContext,f=DisplayObject._hitTestCanvas,h=this._matrix,l=e&1&&(this.onPress||this.onClick||this.onDoubleClick)||e&2&&(this.onMouseOver||this.onMouseOut);if(this.cacheCanvas&&l&&(this.getConcatenatedMatrix(h),d.setTransform(h.a,h.b,h.c,h.d,h.tx-b,h.ty-a),d.globalAlpha=h.alpha,this.draw(d),this._testHit(d)))return f.width=0,f.width=1,this;for(var k=this.children.length-1;k>=0;k--){var j=this.children[k];if(j.isVisible()&&j.mouseEnabled)if(j instanceof c)if(l){if(j=
j._getObjectsUnderPoint(b,a))return this}else{if(j=j._getObjectsUnderPoint(b,a,i,e),!i&&j)return j}else if(!e||l||e&1&&(j.onPress||j.onClick||j.onDoubleClick)||e&2&&(j.onMouseOver||j.onMouseOut)){var g=j.hitArea;j.getConcatenatedMatrix(h);g&&(h.appendTransform(g.x+j.regX,g.y+j.regY,g.scaleX,g.scaleY,g.rotation,g.skewX,g.skewY,g.regX,g.regY),h.alpha*=g.alpha/j.alpha);d.globalAlpha=h.alpha;d.setTransform(h.a,h.b,h.c,h.d,h.tx-b,h.ty-a);(g||j).draw(d);if(this._testHit(d))if(f.width=0,f.width=1,l)return this;
else if(i)i.push(j);else return j}}return null};g.Container=c})(window);(function(g){var c=function(b){this.initialize(b)},a=c.prototype=new Container;c._snapToPixelEnabled=false;a.autoClear=true;a.canvas=null;a.mouseX=null;a.mouseY=null;a.onMouseMove=null;a.onMouseUp=null;a.onMouseDown=null;a.snapToPixelEnabled=false;a.mouseInBounds=false;a.tickOnUpdate=true;a._activeMouseEvent=null;a._activeMouseTarget=null;a._mouseOverIntervalID=null;a._mouseOverX=0;a._mouseOverY=0;a._mouseOverTarget=null;a.Container_initialize=a.initialize;a.initialize=function(b){this.Container_initialize();
...
a.toDataURL=function(b,a){a||(a="image/png");var c=this.canvas.getContext("2d"),e=this.canvas.width,d=this.canvas.height,f;if(b){f=c.getImageData(0,0,e,d);var h=c.globalCompositeOperation;c.globalCompositeOperation="destination-over";c.fillStyle=b;c.fillRect(0,0,e,d)}var g=this.canvas.toDataURL(a);if(b)c.clearRect(0,0,e,d),c.putImageData(f,0,0),c.globalCompositeOperation=h;return g};a.enableMouseOver=function(b){if(this._mouseOverIntervalID)clearInterval(this._mouseOverIntervalID),this._mouseOverIntervalID=
null;if(b==null)b=20;else if(b<=0)return;var a=this;this._mouseOverIntervalID=setInterval(function(){a._testMouseOver()},1E3/Math.min(50,b));this._mouseOverX=NaN;this._mouseOverTarget=null};a.clone=function(){var b=new c(null);this.cloneProps(b);return b};a.toString=function(){return"[Stage (name="+this.name+")]"};a._enableMouseEvents=function(){var b=this,a=g.addEventListener?g:document;a.addEventListener("mouseup",function(a){b._handleMouseUp(a)},false);a.addEventListener("mousemove",function(a){b._handleMouseMove(a)},
false);a.addEventListener("dblclick",function(a){b._handleDoubleClick(a)},false);this.canvas&&this.canvas.addEventListener("mousedown",function(a){b._handleMouseDown(a)},false)};a._handleMouseMove=function(b){if(this.canvas){if(!b)b=g.event;var a=this.mouseInBounds;this._updateMousePosition(b.pageX,b.pageY);if(a||this.mouseInBounds){b=new MouseEvent("onMouseMove",this.mouseX,this.mouseY,this,b);if(this.onMouseMove)this.onMouseMove(b);if(this._activeMouseEvent&&this._activeMouseEvent.onMouseMove)this._activeMouseEvent.onMouseMove(b)}}else this.mouseX=
...
this.graphics.clone():this.graphics);this.cloneProps(a);return a};a.toString=function(){return"[Shape (name="+this.name+")]"};g.Shape=c})(window);(function(g){var c=function(a,c,i){this.initialize(a,c,i)},a=c.prototype=new DisplayObject;c._workingContext=document.createElement("canvas").getContext("2d");a.text="";a.font=null;a.color=null;a.textAlign=null;a.textBaseline=null;a.maxWidth=null;a.outline=false;a.lineHeight=0;a.lineWidth=null;a.DisplayObject_initialize=a.initialize;a.initialize=function(a,c,i){this.DisplayObject_initialize();this.text=a;this.font=c;this.color=i?i:"#000"};a.isVisible=function(){return Boolean(this.visible&&this.alpha>
...
this.outline;a.lineHeight=this.lineHeight;a.lineWidth=this.lineWidth};a._getWorkingContext=function(){var a=c._workingContext;a.font=this.font;a.textAlign=this.textAlign||"start";a.textBaseline=this.textBaseline||"alphabetic";return a};a._drawText=function(a){var c=!!a;c||(a=this._getWorkingContext());for(var i=String(this.text).split(/(?:\r\n|\r|\n)/),e=this.lineHeight||this.getMeasuredLineHeight(),d=0,f=0,h=i.length;f<h;f++){var g=a.measureText(i[f]).width;if(this.lineWidth==null||g<this.lineWidth)c&&
this._drawTextLine(a,i[f],d*e);else{for(var g=i[f].split(/(\s)/),k=g[0],j=1,n=g.length;j<n;j+=2)a.measureText(k+g[j]+g[j+1]).width>this.lineWidth?(c&&this._drawTextLine(a,k,d*e),d++,k=g[j+1]):k+=g[j]+g[j+1];c&&this._drawTextLine(a,k,d*e)}d++}return d};a._drawTextLine=function(a,c,i){this.outline?a.strokeText(c,0,i,this.maxWidth||65535):a.fillText(c,0,i,this.maxWidth||65535)};g.Text=c})(window);(function(g){var c=function(){throw"SpriteSheetUtils cannot be instantiated";};c._workingCanvas=document.createElement("canvas");c._workingContext=c._workingCanvas.getContext("2d");c.addFlippedFrames=function(a,b,g,i){if(b||g||i){var e=0;b&&c._flip(a,++e,true,false);g&&c._flip(a,++e,false,true);i&&c._flip(a,++e,true,true)}};c.extractFrame=function(a,b){isNaN(b)&&(b=a.getAnimation(b).frames[0]);var g=a.getFrame(b);if(!g)return null;var i=g.rect,e=c._workingCanvas;e.width=i.width;e.height=i.height;
c._workingContext.drawImage(g.image,i.x,i.y,i.width,i.height,0,0,i.width,i.height);g=new Image;g.src=e.toDataURL("image/png");return g};c._flip=function(a,b,g,i){for(var e=a._images,d=c._workingCanvas,f=c._workingContext,h=e.length/b,l=0;l<h;l++){var k=e[l];k.__tmp=l;d.width=k.width;d.height=k.height;f.setTransform(g?-1:1,0,0,i?-1:1,g?k.width:0,i?k.height:0);f.drawImage(k,0,0);var j=new Image;j.src=d.toDataURL("image/png");j.width=k.width;j.height=k.height;e.push(j)}f=a._frames;d=f.length/b;for(l=
0;l<d;l++){var k=f[l],n=k.rect.clone(),j=e[k.image.__tmp+h*b],m={image:j,rect:n,regX:k.regX,regY:k.regY};if(g)n.x=j.width-n.x-n.width,m.regX=n.width-k.regX;if(i)n.y=j.height-n.y-n.height,m.regY=n.height-k.regY;f.push(m)}g="_"+(g?"h":"")+(i?"v":"");i=a._animations;a=a._data;e=i.length/b;for(l=0;l<e;l++){f=i[l];k=a[f];h={name:f+g,frequency:k.frequency,next:k.next,frames:[]};k.next&&(h.next+=g);f=k.frames;k=0;for(j=f.length;k<j;k++)h.frames.push(f[k]+d*b);a[h.name]=h;i.push(h.name)}};g.SpriteSheetUtils=
c})(window);(function(g){var c=function(a){this.initialize(a)},a=c.prototype=new DisplayObject;a.htmlElement=null;a._style=null;a.DisplayObject_initialize=a.initialize;a.initialize=function(a){typeof a=="string"&&(a=document.getElementById(a));this.DisplayObject_initialize();this.mouseEnabled=false;if(this.htmlElement=a)this._style=a.style,this._style.position="absolute",this._style.transformOrigin=this._style.webkitTransformOrigin=this._style.msTransformOrigin=this._style.MozTransformOrigin="0% 0%"};a.isVisible=
