...
f.pageY):(h=="touchend"||h=="touchcancel")&&this._handleEnd(a,g,b))}};c._IE_enable=function(a){var b=a.canvas;b.addEventListener("MSPointerDown",function(b){c._IE_handleEvent(a,b)},false);b.addEventListener("MSPointerMove",function(b){c._IE_handleEvent(a,b)},false);b.addEventListener("MSPointerUp",function(b){c._IE_handleEvent(a,b)},false);b.addEventListener("MSPointerCancel",function(b){c._IE_handleEvent(a,b)},false)};c._IE_handleEvent=function(a,b){a.__touch.preventDefault&&(b.preventDefault&&b.preventDefault(),
b.preventManipulation&&b.preventManipulation());var c=b.type,h=b.pointerID;b.srcElement==a.canvas&&(c=="MSPointerDown"?this._handleStart(a,h,b,b.pageX,b.pageY):c=="MSPointerMove"?this._handleMove(a,h,b,b.pageX,b.pageY):(c=="MSPointerUp"||c=="MSPointerCancel")&&this._handleEnd(a,h,b))};c._handleStart=function(a,b,c,h,e){var d=a.__touch;if(d.multitouch||!d.count){var f=d.pointers;f[b]||(f[b]=true,d.count++,a._handlePointerDown(b,c,h,e))}};c._handleMove=function(a,b,c,h,e){a.__touch.pointers[b]&&a._handlePointerMove(b,
c,h,e)};c._handleEnd=function(a,b,c){var h=a.__touch,e=h.pointers;e[b]&&(h.count--,a._handlePointerUp(b,c,true),delete e[b])};i.Touch=c})(window);
