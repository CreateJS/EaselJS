...
c._pausedTime+=i);c._lastTime=a;for(var d=c._pauseable,e=c._listeners.slice(),f=e?e.length:0,h=0;h<f;h++){var k=e[h];k==null||b&&d[h]||(k.tick?k.tick(i,b):k instanceof Function&&k(i,b))}for(c._tickTimes.unshift(c._getTime()-a);c._tickTimes.length>100;)c._tickTimes.pop();for(c._times.unshift(a);c._times.length>100;)c._times.pop()};var b=window.performance&&(performance.now||performance.mozNow||performance.msNow||performance.oNow||performance.webkitNow);c._getTime=function(){return b&&b.call(performance)||
(new Date).getTime()};g.Ticker=c})(createjs||(createjs={}));(function(g){var c=function(a,i,b,d,c,f,h,k,j){this.initialize(a,i,b,d,c,f,h,k,j)},b=c.prototype;b.stageX=0;b.stageY=0;b.rawX=0;b.rawY=0;b.type=null;b.nativeEvent=null;b.onMouseMove=null;b.onMouseUp=null;b.target=null;b.pointerID=0;b.primary=false;b.initialize=function(a,i,b,d,c,f,h,k,j){this.type=a;this.stageX=i;this.stageY=b;this.target=d;this.nativeEvent=c;this.pointerID=f;this.primary=h;this.rawX=k==null?i:k;this.rawY=j==null?b:j};b.clone=function(){return new c(this.type,this.stageX,this.stageY,
this.target,this.nativeEvent,this.pointerID,this.primary,this.rawX,this.rawY)};b.toString=function(){return"[MouseEvent (type="+this.type+" stageX="+this.stageX+" stageY="+this.stageY+")]"};g.MouseEvent=c})(createjs||(createjs={}));(function(g){var c=function(a,i,b,d,c,f){this.initialize(a,i,b,d,c,f)},b=c.prototype;c.identity=null;c.DEG_TO_RAD=Math.PI/180;b.a=1;b.b=0;b.c=0;b.d=1;b.tx=0;b.ty=0;b.alpha=1;b.shadow=null;b.compositeOperation=null;b.initialize=function(a,i,b,d,c,f){if(a!=null)this.a=a;this.b=i||0;this.c=b||0;if(d!=null)this.d=d;this.tx=c||0;this.ty=f||0;return this};b.prepend=function(a,i,b,d,c,f){var h=this.tx;if(a!=1||i!=0||b!=0||d!=1){var k=this.a,j=this.c;this.a=k*a+this.b*b;this.b=k*i+this.b*d;this.c=j*a+this.d*
b;this.d=j*i+this.d*d}this.tx=h*a+this.ty*b+c;this.ty=h*i+this.ty*d+f;return this};b.append=function(a,i,b,d,c,f){var h=this.a,k=this.b,j=this.c,l=this.d;this.a=a*h+i*j;this.b=a*k+i*l;this.c=b*h+d*j;this.d=b*k+d*l;this.tx=c*h+f*j+this.tx;this.ty=c*k+f*l+this.ty;return this};b.prependMatrix=function(a){this.prepend(a.a,a.b,a.c,a.d,a.tx,a.ty);this.prependProperties(a.alpha,a.shadow,a.compositeOperation);return this};b.appendMatrix=function(a){this.append(a.a,a.b,a.c,a.d,a.tx,a.ty);this.appendProperties(a.alpha,
a.shadow,a.compositeOperation);return this};b.prependTransform=function(a,i,b,d,e,f,h,k,j){if(e%360)var l=e*c.DEG_TO_RAD,e=Math.cos(l),l=Math.sin(l);else e=1,l=0;if(k||j)this.tx-=k,this.ty-=j;f||h?(f*=c.DEG_TO_RAD,h*=c.DEG_TO_RAD,this.prepend(e*b,l*b,-l*d,e*d,0,0),this.prepend(Math.cos(h),Math.sin(h),-Math.sin(f),Math.cos(f),a,i)):this.prepend(e*b,l*b,-l*d,e*d,a,i);return this};b.appendTransform=function(a,i,b,d,e,f,h,k,j){if(e%360)var l=e*c.DEG_TO_RAD,e=Math.cos(l),l=Math.sin(l);else e=1,l=0;f||
h?(f*=c.DEG_TO_RAD,h*=c.DEG_TO_RAD,this.append(Math.cos(h),Math.sin(h),-Math.sin(f),Math.cos(f),a,i),this.append(e*b,l*b,-l*d,e*d,0,0)):this.append(e*b,l*b,-l*d,e*d,a,i);if(k||j)this.tx-=k*this.a+j*this.c,this.ty-=k*this.b+j*this.d;return this};b.rotate=function(a){var i=Math.cos(a),a=Math.sin(a),b=this.a,d=this.c,c=this.tx;this.a=b*i-this.b*a;this.b=b*a+this.b*i;this.c=d*i-this.d*a;this.d=d*a+this.d*i;this.tx=c*i-this.ty*a;this.ty=c*a+this.ty*i;return this};b.skew=function(a,i){a*=c.DEG_TO_RAD;i*=
c.DEG_TO_RAD;this.append(Math.cos(i),Math.sin(i),-Math.sin(a),Math.cos(a),0,0);return this};b.scale=function(a,i){this.a*=a;this.d*=i;this.tx*=a;this.ty*=i;return this};b.translate=function(a,i){this.tx+=a;this.ty+=i;return this};b.identity=function(){this.alpha=this.a=this.d=1;this.b=this.c=this.tx=this.ty=0;this.shadow=this.compositeOperation=null;return this};b.invert=function(){var a=this.a,i=this.b,b=this.c,d=this.d,c=this.tx,f=a*d-i*b;this.a=d/f;this.b=-i/f;this.c=-b/f;this.d=a/f;this.tx=(b*
this.ty-d*c)/f;this.ty=-(a*this.ty-i*c)/f;return this};b.isIdentity=function(){return this.tx==0&&this.ty==0&&this.a==1&&this.b==0&&this.c==0&&this.d==1};b.decompose=function(a){a==null&&(a={});a.x=this.tx;a.y=this.ty;a.scaleX=Math.sqrt(this.a*this.a+this.b*this.b);a.scaleY=Math.sqrt(this.c*this.c+this.d*this.d);var i=Math.atan2(-this.c,this.d),b=Math.atan2(this.b,this.a);i==b?(a.rotation=b/c.DEG_TO_RAD,this.a<0&&this.d>=0&&(a.rotation+=a.rotation<=0?180:-180),a.skewX=a.skewY=0):(a.skewX=i/c.DEG_TO_RAD,
a.skewY=b/c.DEG_TO_RAD);return a};b.reinitialize=function(a,i,b,c,e,f,h,k,j){this.initialize(a,i,b,c,e,f);this.alpha=h||1;this.shadow=k;this.compositeOperation=j;return this};b.appendProperties=function(a,i,b){this.alpha*=a;this.shadow=i||this.shadow;this.compositeOperation=b||this.compositeOperation;return this};b.prependProperties=function(a,i,b){this.alpha*=a;this.shadow=this.shadow||i;this.compositeOperation=this.compositeOperation||b;return this};b.clone=function(){var a=new c(this.a,this.b,
...
return this};a.beginLinearGradientFill=function(a,b,d,e,f,h){this._active&&this._newPath();d=this._ctx.createLinearGradient(d,e,f,h);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",d],false)];return this};a.beginRadialGradientFill=function(a,b,d,e,f,h,k,j){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,h,k,j);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",
...
["strokeStyle",d],false)];return this};a.beginRadialGradientStroke=function(a,b,d,e,f,h,k,j){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,h,k,j);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.beginBitmapStroke=function(a,b){this._active&&this._newPath();var d=this._ctx.createPattern(a,b||"");this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.endStroke=
function(){this.beginStroke();return this};a.curveTo=a.quadraticCurveTo;a.drawRect=a.rect;a.drawRoundRect=function(a,b,c,e,f){this.drawRoundRectComplex(a,b,c,e,f,f,f,f);return this};a.drawRoundRectComplex=function(a,b,d,e,f,h,k,j){var l=(d<e?d:e)/2,g=0,o=0,q=0,r=0;f<0&&(f*=g=-1);f>l&&(f=l);h<0&&(h*=o=-1);h>l&&(h=l);k<0&&(k*=q=-1);k>l&&(k=l);j<0&&(j*=r=-1);j>l&&(j=l);this._dirty=this._active=true;var l=this._ctx.arcTo,p=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[a+d-h,b]),
new c(l,[a+d+h*o,b-h*o,a+d,b+h,h]),new c(p,[a+d,b+e-k]),new c(l,[a+d+k*q,b+e+k*q,a+d-k,b+e,k]),new c(p,[a+j,b+e]),new c(l,[a-j*r,b+e+j*r,a,b+e-j,j]),new c(p,[a,b+f]),new c(l,[a-f*g,b-f*g,a+f,b,f]),new c(this._ctx.closePath));return this};a.drawCircle=function(a,b,c){this.arc(a,b,c,0,Math.PI*2);return this};a.drawEllipse=function(a,b,d,e){this._dirty=this._active=true;var f=d/2*0.5522848,h=e/2*0.5522848,k=a+d,j=b+e,d=a+d/2,e=b+e/2;this._activeInstructions.push(new c(this._ctx.moveTo,[a,e]),new c(this._ctx.bezierCurveTo,
[a,e-h,d-f,b,d,b]),new c(this._ctx.bezierCurveTo,[d+f,b,k,e-h,k,e]),new c(this._ctx.bezierCurveTo,[k,e+h,d+f,j,d,j]),new c(this._ctx.bezierCurveTo,[d-f,j,a,e+h,a,e]));return this};a.drawPolyStar=function(a,b,d,e,f,h){this._dirty=this._active=true;f==null&&(f=0);f=1-f;h==null?h=0:h/=180/Math.PI;var k=Math.PI/e;this._activeInstructions.push(new c(this._ctx.moveTo,[a+Math.cos(h)*d,b+Math.sin(h)*d]));for(var j=0;j<e;j++)h+=k,f!=1&&this._activeInstructions.push(new c(this._ctx.lineTo,[a+Math.cos(h)*d*
f,b+Math.sin(h)*d*f])),h+=k,this._activeInstructions.push(new c(this._ctx.lineTo,[a+Math.cos(h)*d,b+Math.sin(h)*d]));return this};a.decodePath=function(a){for(var c=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],d=[2,2,4,6],e=0,f=a.length,h=[],k=0,j=0,g=b.BASE_64;e<f;){var m=a.charAt(e),o=g[m],q=o>>3,r=c[q];if(!r||o&3)throw"bad path data (@"+e+"): "+m;m=d[q];q||(k=j=0);h.length=0;e++;o=(o>>2&1)+2;for(q=0;q<m;q++){var p=g[a.charAt(e)],s=p>>5?-1:1,p=(p&31)<<6|g[a.charAt(e+1)];o==
3&&(p=p<<6|g[a.charAt(e+2)]);p=s*p/10;q%2?k=p+=k:j=p+=j;h[q]=p;e+=o}r.apply(this,h)}return this};a.clone=function(){var a=new b;a._instructions=this._instructions.slice();a._activeInstructions=this._activeInstructions.slice();a._oldInstructions=this._oldInstructions.slice();if(this._fillInstructions)a._fillInstructions=this._fillInstructions.slice();if(this._strokeInstructions)a._strokeInstructions=this._strokeInstructions.slice();if(this._strokeStyleInstructions)a._strokeStyleInstructions=this._strokeStyleInstructions.slice();
...
this._instructions.push.apply(this._instructions,this._strokeStyleInstructions));this._instructions.push.apply(this._instructions,this._activeInstructions);this._fillInstructions&&this._instructions.push(b.fillCmd);this._strokeInstructions&&this._instructions.push(b.strokeCmd)};a._getEllipseArc=function(a,b,d,e){var f=d/2*0.5522848,h=e/2*0.5522848,k=a+d,j=b+e,d=a+d/2,e=b+e/2;this._activeInstructions.push(new c(this._ctx.moveTo,[a,e]),new c(this._ctx.bezierCurveTo,[a,e-h,d-f,b,d,b]),new c(this._ctx.bezierCurveTo,
...
b.b,b.c,b.d,b.tx,b.ty);a.globalAlpha*=this.alpha;if(this.compositeOperation)a.globalCompositeOperation=this.compositeOperation;this.shadow&&this._applyShadow(a,this.shadow)};b.cache=function(a,b,c,d){if(!this.cacheCanvas)this.cacheCanvas=g.getCanvas?g.getCanvas():document.createElement("canvas");this.cacheCanvas.width=c;this.cacheCanvas.height=d;this._cacheOffsetX=a;this._cacheOffsetY=b;this.updateCache()};b.updateCache=function(a){var b=this.cacheCanvas,n=this._cacheOffsetX,d=this._cacheOffsetY;
if(!b)throw"cache() must be called before updateCache()";var e=b.getContext("2d");a?e.globalCompositeOperation=a:e.clearRect(0,0,b.width,b.height);e.setTransform(1,0,0,1,-n,-d);this.draw(e,true,this._matrix.reinitialize(1,0,0,1,-n,-d));e.globalCompositeOperation="source-over";this._applyFilters();this.cacheID=c._nextCacheID++};b.uncache=function(){this._cacheDataURL=this.cacheCanvas=null;this.cacheID=this._cacheOffsetX=this._cacheOffsetY=0};b.getCacheDataURL=function(){if(!this.cacheCanvas)return null;
if(this.cacheID!=this._cacheDataURLID)this._cacheDataURL=this.cacheCanvas.toDataURL();return this._cacheDataURL};b.getStage=function(){for(var a=this;a.parent;)a=a.parent;return a instanceof g.Stage?a:null};b.localToGlobal=function(a,b){var c=this.getConcatenatedMatrix(this._matrix);if(c==null)return null;c.append(1,0,0,1,a,b);return new g.Point(c.tx,c.ty)};b.globalToLocal=function(a,b){var c=this.getConcatenatedMatrix(this._matrix);if(c==null)return null;c.invert();c.append(1,0,0,1,a,b);return new g.Point(c.tx,
c.ty)};b.localToLocal=function(a,b,c){a=this.localToGlobal(a,b);return c.globalToLocal(a.x,a.y)};b.setTransform=function(a,b,c,d,e,f,h,k,j){this.x=a||0;this.y=b||0;this.scaleX=c==null?1:c;this.scaleY=d==null?1:d;this.rotation=e||0;this.skewX=f||0;this.skewY=h||0;this.regX=k||0;this.regY=j||0};b.getMatrix=function(a){return(a?a.identity():new g.Matrix2D).appendTransform(this.x,this.y,this.scaleX,this.scaleY,this.rotation,this.skewX,this.skewY,this.regX,this.regY).appendProperties(this.alpha,this.shadow,
this.compositeOperation)};b.getConcatenatedMatrix=function(a){a?a.identity():a=new g.Matrix2D;for(var b=this;b!=null;)a.prependTransform(b.x,b.y,b.scaleX,b.scaleY,b.rotation,b.skewX,b.skewY,b.regX,b.regY).prependProperties(b.alpha,b.shadow,b.compositeOperation),b=b.parent;return a};b.hitTest=function(a,b){var n=c._hitTestContext,d=c._hitTestCanvas;n.setTransform(1,0,0,1,-a,-b);this.draw(n);n=this._testHit(n);d.width=0;d.width=1;return n};b.clone=function(){var a=new c;this.cloneProps(a);return a};
b.toString=function(){return"[DisplayObject (name="+this.name+")]"};b.cloneProps=function(a){a.alpha=this.alpha;a.name=this.name;a.regX=this.regX;a.regY=this.regY;a.rotation=this.rotation;a.scaleX=this.scaleX;a.scaleY=this.scaleY;a.shadow=this.shadow;a.skewX=this.skewX;a.skewY=this.skewY;a.visible=this.visible;a.x=this.x;a.y=this.y;a.mouseEnabled=this.mouseEnabled;a.compositeOperation=this.compositeOperation;if(this.cacheCanvas)a.cacheCanvas=this.cacheCanvas.cloneNode(true),a.cacheCanvas.getContext("2d").putImageData(this.cacheCanvas.getContext("2d").getImageData(0,
...
c._tick&&c._tick(a)}if(this.onTick)this.onTick(a)};b._getObjectsUnderPoint=function(a,b,n,d){var e=createjs.DisplayObject._hitTestContext,f=createjs.DisplayObject._hitTestCanvas,h=this._matrix,k=d&1&&(this.onPress||this.onClick||this.onDoubleClick)||d&2&&(this.onMouseOver||this.onMouseOut);if(this.cacheCanvas&&k&&(this.getConcatenatedMatrix(h),e.setTransform(h.a,h.b,h.c,h.d,h.tx-a,h.ty-b),e.globalAlpha=h.alpha,this.draw(e),this._testHit(e)))return f.width=0,f.width=1,this;for(var j=this.children.length-
1;j>=0;j--){var g=this.children[j];if(g.isVisible()&&g.mouseEnabled)if(g instanceof c)if(k){if(g=g._getObjectsUnderPoint(a,b))return this}else{if(g=g._getObjectsUnderPoint(a,b,n,d),!n&&g)return g}else if(!d||k||d&1&&(g.onPress||g.onClick||g.onDoubleClick)||d&2&&(g.onMouseOver||g.onMouseOut)){var m=g.hitArea;g.getConcatenatedMatrix(h);m&&(h.appendTransform(m.x+g.regX,m.y+g.regY,m.scaleX,m.scaleY,m.rotation,m.skewX,m.skewY,m.regX,m.regY),h.alpha*=m.alpha/g.alpha);e.globalAlpha=h.alpha;e.setTransform(h.a,
h.b,h.c,h.d,h.tx-a,h.ty-b);(m||g).draw(e);if(this._testHit(e))if(f.width=0,f.width=1,k)return this;else if(n)n.push(g);else return g}}return null};g.Container=c})(createjs||(createjs={}));(function(g){var c=function(a){this.initialize(a)},b=c.prototype=new g.Container;c._snapToPixelEnabled=false;b.autoClear=true;b.canvas=null;b.mouseX=null;b.mouseY=null;b.onMouseMove=null;b.onMouseUp=null;b.onMouseDown=null;b.snapToPixelEnabled=false;b.mouseInBounds=false;b.tickOnUpdate=true;b.mouseMoveOutside=false;b._pointerData=null;b._pointerCount=0;b._primaryPointerID=null;b._mouseOverIntervalID=null;b.Container_initialize=b.initialize;b.initialize=function(a){this.Container_initialize();this.canvas=
...
this._drawTextLine(a,c[f],e*d);else{for(var g=c[f].split(/(\s)/),j=g[0],l=1,m=g.length;l<m;l+=2)a.measureText(j+g[l]+g[l+1]).width>this.lineWidth?(b&&this._drawTextLine(a,j,e*d),e++,j=g[l+1]):j+=g[l]+g[l+1];b&&this._drawTextLine(a,j,e*d)}e++}return e};b._drawTextLine=function(a,b,c){this.outline?a.strokeText(b,0,c,this.maxWidth||65535):a.fillText(b,0,c,this.maxWidth||65535)};g.Text=c})(createjs||(createjs={}));(function(g){var c=function(){throw"SpriteSheetUtils cannot be instantiated";};c._workingCanvas=g.getCanvas?g.getCanvas():document.createElement("canvas");c._workingContext=c._workingCanvas.getContext("2d");c.addFlippedFrames=function(b,a,i,g){if(a||i||g){var d=0;a&&c._flip(b,++d,true,false);i&&c._flip(b,++d,false,true);g&&c._flip(b,++d,true,true)}};c.extractFrame=function(b,a){isNaN(a)&&(a=b.getAnimation(a).frames[0]);var i=b.getFrame(a);if(!i)return null;var g=i.rect,d=c._workingCanvas;d.width=
g.width;d.height=g.height;c._workingContext.drawImage(i.image,g.x,g.y,g.width,g.height,0,0,g.width,g.height);i=new Image;i.src=d.toDataURL("image/png");return i};c.mergeAlpha=function(b,a,c){c||(c=g.getCanvas?g.getCanvas():document.createElement("canvas"));c.width=Math.max(a.width,b.width);c.height=Math.max(a.height,b.height);var n=c.getContext("2d");n.save();n.drawImage(b,0,0);n.globalCompositeOperation="destination-in";n.drawImage(a,0,0);n.restore();return c};c._flip=function(b,a,i,g){for(var d=
b._images,e=c._workingCanvas,f=c._workingContext,h=d.length/a,k=0;k<h;k++){var j=d[k];j.__tmp=k;e.width=j.width;e.height=j.height;f.setTransform(i?-1:1,0,0,g?-1:1,i?j.width:0,g?j.height:0);f.drawImage(j,0,0);var l=new Image;l.src=e.toDataURL("image/png");l.width=j.width;l.height=j.height;d.push(l)}f=b._frames;e=f.length/a;for(k=0;k<e;k++){var j=f[k],m=j.rect.clone(),l=d[j.image.__tmp+h*a],o={image:l,rect:m,regX:j.regX,regY:j.regY};if(i)m.x=l.width-m.x-m.width,o.regX=m.width-j.regX;if(g)m.y=l.height-
m.y-m.height,o.regY=m.height-j.regY;f.push(o)}i="_"+(i?"h":"")+(g?"v":"");g=b._animations;b=b._data;d=g.length/a;for(k=0;k<d;k++){f=g[k];j=b[f];h={name:f+i,frequency:j.frequency,next:j.next,frames:[]};j.next&&(h.next+=i);f=j.frames;j=0;for(l=f.length;j<l;j++)h.frames.push(f[j]+e*a);b[h.name]=h;g.push(h.name)}};g.SpriteSheetUtils=c})(createjs||(createjs={}));(function(g){var c=function(){this.initialize()},b=c.prototype;c.ERR_DIMENSIONS="frame dimensions exceed max spritesheet dimensions";c.ERR_RUNNING="a build is already running";b.maxWidth=2048;b.maxHeight=2048;b.spriteSheet=null;b.scale=1;b._frames=null;b._animations=null;b._data=null;b._nextFrameIndex=0;b._index=0;b._callback=null;b._timeSlice=null;b._timerID=null;b._scale=1;b.initialize=function(){this._frames=[];this._animations={}};b.addFrame=function(a,b,g,d,e,f){if(this._data)throw c.ERR_RUNNING;
...
b){return a.height<=b.height?-1:1});if(b[b.length-1].height>this.maxHeight)throw c.ERR_DIMENSIONS;for(var n=1,d=1,e=0;b.length;){var f=this._fillRow(b,n,e,a);if(f.w>d)d=f.w;n+=f.h+2;if(!f.h||!b.length){var h=g.getCanvas?g.getCanvas():document.createElement("canvas");h.width=this._getSize(d,this.maxWidth);h.height=this._getSize(n,this.maxHeight);this._data.images[e]=h;f.h||(d=n=1,e++)}}};b._getSize=function(a,b){for(var c=4;Math.pow(2,++c)<a;);return Math.min(b,Math.pow(2,c))};b._fillRow=function(a,
b,n,d){for(var e=this.maxWidth,f=this.maxHeight-b,h=1,k=0,j=a.length-1;j>=0;j--){var l=a[j],m=this._scale*l.scale,o=l.sourceRect,q=l.source,r=Math.floor(m*o.x-1),p=Math.floor(m*o.y-1),s=Math.ceil(m*o.height),o=Math.ceil(m*o.width);if(o>e)throw c.ERR_DIMENSIONS;if(!(s>f||h+o>e))l.img=n,l.rect=new g.Rectangle(h,b,o,s),k=k||s,a.splice(j,1),d[l.index]=[h-1,b-1,o+2,s+2,n,Math.round(-r+m*q.regX),Math.round(-p+m*q.regY)],h+=o+2}return{w:h,h:k}};b._endBuild=function(){this.spriteSheet=new g.SpriteSheet(this._data);
