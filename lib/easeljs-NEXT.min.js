...
c._tickTimes=[];c._pauseable=[];c._listeners=[];c._times.push(c._lastTime=c._startTime=c._getTime());c.setInterval(c._interval)};c.removeListener=function(a){var j=c._listeners;j&&(a=j.indexOf(a),a!=-1&&(j.splice(a,1),c._pauseable.splice(a,1)))};c.removeAllListeners=function(){c._listeners=[];c._pauseable=[]};c.setInterval=function(a){c._interval=a;c._inited&&c._setupTick()};c.getInterval=function(){return c._interval};c.setFPS=function(a){c.setInterval(1E3/a)};c.getFPS=function(){return 1E3/c._interval};
...
c._pausedTime+=j);c._lastTime=a;for(var d=c._pauseable,e=c._listeners.slice(),f=e?e.length:0,g=0;g<f;g++){var i=e[g];i==null||b&&d[g]||(i.tick?i.tick(j,b):i instanceof Function&&i(j,b))}for(c._tickTimes.unshift(c._getTime()-a);c._tickTimes.length>100;)c._tickTimes.pop();for(c._times.unshift(a);c._times.length>100;)c._times.pop()};var b=window.performance&&(performance.now||performance.mozNow||performance.msNow||performance.oNow||performance.webkitNow);c._getTime=function(){return b&&b.call(performance)||
(new Date).getTime()};createjs.Ticker=c})();this.createjs=this.createjs||{};
(function(){function c(a,b,d){this.f=a;this.scope=b;this.priority=d}var b=function(){this.initialize()},a=b.prototype;b.initialize=function(j){j.addEventListener=a.addEventListener;j.removeEventListener=a.removeEventListener;j.removeAllEventListeners=a.removeAllEventListeners;j.hasEventListener=a.hasEventListener;j.dispatchEvent=a.dispatchEvent};a._listeners=null;a.initialize=function(){};a.addEventListener=function(a,b,d,e){var e=e||0,f=new c(b,d||this,e),g=this._listeners;if(!g)g=this._listeners=
{};var i=g[a];if(i){this.removeEventListener(a,b,d);a=0;for(b=i.length;a<b&&i[a].priority>=e;a++);i.splice(a,0,f)}else g[a]=[f]};a.removeEventListener=function(a,b,d){var e=this._listeners;if(e){var c=e[a];if(c)for(var d=d||this,g=0,i=c.length;g<i;g++){var k=c[g];if(k.f==b&&k.scope==d){i==1?delete e[a]:c.splice(g,1);break}}}};a.removeAllEventListeners=function(a){a?this._listeners&&delete this._listeners[a]:this._listeners=null};a.dispatchEvent=function(a,b,d){b&&b.apply(this,d);var b=false,e=this._listeners;
...
(function(){var c=function(a,j,b,d,e,c,g,i,k){this.initialize(a,j,b,d,e,c,g,i,k)},b=c.prototype;b.stageX=0;b.stageY=0;b.rawX=0;b.rawY=0;b.type=null;b.nativeEvent=null;b.onMouseMove=null;b.onMouseUp=null;b.target=null;b.pointerID=0;b.primary=false;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher&&createjs.EventDispatcher.initialize(b);b.initialize=function(a,j,b,d,e,c,g,i,k){this.type=
a;this.stageX=j;this.stageY=b;this.target=d;this.nativeEvent=e;this.pointerID=c;this.primary=g;this.rawX=i==null?j:i;this.rawY=k==null?b:k};b.clone=function(){return new c(this.type,this.stageX,this.stageY,this.target,this.nativeEvent,this.pointerID,this.primary,this.rawX,this.rawY)};b.toString=function(){return"[MouseEvent (type="+this.type+" stageX="+this.stageX+" stageY="+this.stageY+")]"};createjs.MouseEvent=c})();this.createjs=this.createjs||{};
(function(){var c=function(a,j,b,d,e,c){this.initialize(a,j,b,d,e,c)},b=c.prototype;c.identity=null;c.DEG_TO_RAD=Math.PI/180;b.a=1;b.b=0;b.c=0;b.d=1;b.tx=0;b.ty=0;b.alpha=1;b.shadow=null;b.compositeOperation=null;b.initialize=function(a,j,b,d,e,c){if(a!=null)this.a=a;this.b=j||0;this.c=b||0;if(d!=null)this.d=d;this.tx=e||0;this.ty=c||0;return this};b.prepend=function(a,j,b,d,e,c){var g=this.tx;if(a!=1||j!=0||b!=0||d!=1){var i=this.a,k=this.c;this.a=i*a+this.b*b;this.b=i*j+this.b*d;this.c=k*a+this.d*
b;this.d=k*j+this.d*d}this.tx=g*a+this.ty*b+e;this.ty=g*j+this.ty*d+c;return this};b.append=function(a,j,b,d,e,c){var g=this.a,i=this.b,k=this.c,l=this.d;this.a=a*g+j*k;this.b=a*i+j*l;this.c=b*g+d*k;this.d=b*i+d*l;this.tx=e*g+c*k+this.tx;this.ty=e*i+c*l+this.ty;return this};b.prependMatrix=function(a){this.prepend(a.a,a.b,a.c,a.d,a.tx,a.ty);this.prependProperties(a.alpha,a.shadow,a.compositeOperation);return this};b.appendMatrix=function(a){this.append(a.a,a.b,a.c,a.d,a.tx,a.ty);this.appendProperties(a.alpha,
a.shadow,a.compositeOperation);return this};b.prependTransform=function(a,j,b,d,e,f,g,i,k){if(e%360)var l=e*c.DEG_TO_RAD,e=Math.cos(l),l=Math.sin(l);else e=1,l=0;if(i||k)this.tx-=i,this.ty-=k;f||g?(f*=c.DEG_TO_RAD,g*=c.DEG_TO_RAD,this.prepend(e*b,l*b,-l*d,e*d,0,0),this.prepend(Math.cos(g),Math.sin(g),-Math.sin(f),Math.cos(f),a,j)):this.prepend(e*b,l*b,-l*d,e*d,a,j);return this};b.appendTransform=function(a,j,b,d,e,f,g,i,k){if(e%360)var l=e*c.DEG_TO_RAD,e=Math.cos(l),l=Math.sin(l);else e=1,l=0;f||
g?(f*=c.DEG_TO_RAD,g*=c.DEG_TO_RAD,this.append(Math.cos(g),Math.sin(g),-Math.sin(f),Math.cos(f),a,j),this.append(e*b,l*b,-l*d,e*d,0,0)):this.append(e*b,l*b,-l*d,e*d,a,j);if(i||k)this.tx-=i*this.a+k*this.c,this.ty-=i*this.b+k*this.d;return this};b.rotate=function(a){var j=Math.cos(a),a=Math.sin(a),b=this.a,d=this.c,e=this.tx;this.a=b*j-this.b*a;this.b=b*a+this.b*j;this.c=d*j-this.d*a;this.d=d*a+this.d*j;this.tx=e*j-this.ty*a;this.ty=e*a+this.ty*j;return this};b.skew=function(a,j){a*=c.DEG_TO_RAD;j*=
...
(function(){var c=function(a){this.initialize(a)},b=c.prototype;b.complete=true;b.onComplete=null;b._animations=null;b._frames=null;b._images=null;b._data=null;b._loadCount=0;b._frameHeight=0;b._frameWidth=0;b._numFrames=0;b._regX=0;b._regY=0;b.initialize=function(a){var b,h,d;if(a!=null){if(a.images&&(h=a.images.length)>0){d=this._images=[];for(b=0;b<h;b++){var e=a.images[b];if(typeof e=="string"){var c=e,e=new Image;e.src=c}d.push(e);if(!e.getContext&&!e.complete)this._loadCount++,this.complete=
false,function(a){e.onload=function(){a._handleImageLoad()}}(this)}}if(a.frames!=null)if(a.frames instanceof Array){this._frames=[];d=a.frames;for(b=0,h=d.length;b<h;b++)c=d[b],this._frames.push({image:this._images[c[4]?c[4]:0],rect:new createjs.Rectangle(c[0],c[1],c[2],c[3]),regX:c[5]||0,regY:c[6]||0})}else h=a.frames,this._frameWidth=h.width,this._frameHeight=h.height,this._regX=h.regX||0,this._regY=h.regY||0,this._numFrames=h.count,this._loadCount==0&&this._calculateFrames();if((h=a.animations)!=
null){this._animations=[];this._data={};for(var g in h){a={name:g};c=h[g];if(isNaN(c))if(c instanceof Array){a.frequency=c[3];a.next=c[2];d=a.frames=[];for(b=c[0];b<=c[1];b++)d.push(b)}else a.frequency=c.frequency,a.next=c.next,b=c.frames,d=a.frames=!isNaN(b)?[b]:b.slice(0);else d=a.frames=[c];a.next=d.length<2||a.next==false?null:a.next==null||a.next==true?g:a.next;if(!a.frequency)a.frequency=1;this._animations.push(g);this._data[g]=a}}}};b.getNumFrames=function(a){return a==null?this._frames?this._frames.length:
...
return this};a.beginLinearGradientFill=function(a,b,d,e,f,g){this._active&&this._newPath();d=this._ctx.createLinearGradient(d,e,f,g);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",d],false)];return this};a.beginRadialGradientFill=function(a,b,d,e,f,g,i,k){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,g,i,k);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._fillInstructions=[new c(this._setProp,["fillStyle",
...
["strokeStyle",d],false)];return this};a.beginRadialGradientStroke=function(a,b,d,e,f,g,i,k){this._active&&this._newPath();d=this._ctx.createRadialGradient(d,e,f,g,i,k);e=0;for(f=a.length;e<f;e++)d.addColorStop(b[e],a[e]);this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.beginBitmapStroke=function(a,b){this._active&&this._newPath();var d=this._ctx.createPattern(a,b||"");this._strokeInstructions=[new c(this._setProp,["strokeStyle",d],false)];return this};a.endStroke=
function(){this.beginStroke();return this};a.curveTo=a.quadraticCurveTo;a.drawRect=a.rect;a.drawRoundRect=function(a,b,d,c,f){this.drawRoundRectComplex(a,b,d,c,f,f,f,f);return this};a.drawRoundRectComplex=function(a,b,d,e,f,g,i,k){var l=(d<e?d:e)/2,m=0,n=0,o=0,q=0;f<0&&(f*=m=-1);f>l&&(f=l);g<0&&(g*=n=-1);g>l&&(g=l);i<0&&(i*=o=-1);i>l&&(i=l);k<0&&(k*=q=-1);k>l&&(k=l);this._dirty=this._active=true;var l=this._ctx.arcTo,p=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[a+d-g,b]),
new c(l,[a+d+g*n,b-g*n,a+d,b+g,g]),new c(p,[a+d,b+e-i]),new c(l,[a+d+i*o,b+e+i*o,a+d-i,b+e,i]),new c(p,[a+k,b+e]),new c(l,[a-k*q,b+e+k*q,a,b+e-k,k]),new c(p,[a,b+f]),new c(l,[a-f*m,b-f*m,a+f,b,f]),new c(this._ctx.closePath));return this};a.drawCircle=function(a,b,d){this.arc(a,b,d,0,Math.PI*2);return this};a.drawEllipse=function(a,b,d,e){this._dirty=this._active=true;var f=d/2*0.5522848,g=e/2*0.5522848,i=a+d,k=b+e,d=a+d/2,e=b+e/2;this._activeInstructions.push(new c(this._ctx.moveTo,[a,e]),new c(this._ctx.bezierCurveTo,
[a,e-g,d-f,b,d,b]),new c(this._ctx.bezierCurveTo,[d+f,b,i,e-g,i,e]),new c(this._ctx.bezierCurveTo,[i,e+g,d+f,k,d,k]),new c(this._ctx.bezierCurveTo,[d-f,k,a,e+g,a,e]));return this};a.drawPolyStar=function(a,b,d,e,f,g){this._dirty=this._active=true;f==null&&(f=0);f=1-f;g==null?g=0:g/=180/Math.PI;var i=Math.PI/e;this._activeInstructions.push(new c(this._ctx.moveTo,[a+Math.cos(g)*d,b+Math.sin(g)*d]));for(var k=0;k<e;k++)g+=i,f!=1&&this._activeInstructions.push(new c(this._ctx.lineTo,[a+Math.cos(g)*d*
f,b+Math.sin(g)*d*f])),g+=i,this._activeInstructions.push(new c(this._ctx.lineTo,[a+Math.cos(g)*d,b+Math.sin(g)*d]));return this};a.decodePath=function(a){for(var c=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo,this.closePath],d=[2,2,4,6,0],e=0,f=a.length,g=[],i=0,k=0,l=b.BASE_64;e<f;){var m=a.charAt(e),n=l[m],o=n>>3,q=c[o];if(!q||n&3)throw"bad path data (@"+e+"): "+m;m=d[o];o||(i=k=0);g.length=0;e++;n=(n>>2&1)+2;for(o=0;o<m;o++){var p=l[a.charAt(e)],s=p>>5?-1:1,p=(p&31)<<6|l[a.charAt(e+
1)];n==3&&(p=p<<6|l[a.charAt(e+2)]);p=s*p/10;o%2?i=p+=i:k=p+=k;g[o]=p;e+=n}q.apply(this,g)}return this};a.clone=function(){var a=new b;a._instructions=this._instructions.slice();a._activeInstructions=this._activeInstructions.slice();a._oldInstructions=this._oldInstructions.slice();if(this._fillInstructions)a._fillInstructions=this._fillInstructions.slice();if(this._strokeInstructions)a._strokeInstructions=this._strokeInstructions.slice();if(this._strokeStyleInstructions)a._strokeStyleInstructions=
...
this._instructions.push.apply(this._instructions,this._strokeStyleInstructions));this._instructions.push.apply(this._instructions,this._activeInstructions);this._fillInstructions&&this._instructions.push(b.fillCmd);this._strokeInstructions&&this._instructions.push(b.strokeCmd)};a._getEllipseArc=function(a,b,d,e){var f=d/2*0.5522848,g=e/2*0.5522848,i=a+d,k=b+e,d=a+d/2,e=b+e/2;this._activeInstructions.push(new c(this._ctx.moveTo,[a,e]),new c(this._ctx.bezierCurveTo,[a,e-g,d-f,b,d,b]),new c(this._ctx.bezierCurveTo,
[d+f,b,i,e-g,i,e]),new c(this._ctx.bezierCurveTo,[i,e+g,d+f,k,d,k]),new c(this._ctx.bezierCurveTo,[d-f,k,a,e+g,a,e]));return this};a._newPath=function(){this._dirty&&this._updateInstructions();this._oldInstructions=this._instructions;this._activeInstructions=[];this._active=this._dirty=false};a._setProp=function(a,b){this[a]=b};createjs.Graphics=b})();this.createjs=this.createjs||{};
...
a.y)};b.setTransform=function(a,b,c,d,e,f,g,i,k){this.x=a||0;this.y=b||0;this.scaleX=c==null?1:c;this.scaleY=d==null?1:d;this.rotation=e||0;this.skewX=f||0;this.skewY=g||0;this.regX=i||0;this.regY=k||0;return this};b.getMatrix=function(a){return(a?a.identity():new createjs.Matrix2D).appendTransform(this.x,this.y,this.scaleX,this.scaleY,this.rotation,this.skewX,this.skewY,this.regX,this.regY).appendProperties(this.alpha,this.shadow,this.compositeOperation)};b.getConcatenatedMatrix=function(a){a?a.identity():
...
g;f++){var i=a.measureText(c[f]).width;if(this.lineWidth==null||i<this.lineWidth)b&&this._drawTextLine(a,c[f],e*d);else{for(var i=c[f].split(/(\s)/),k=i[0],l=1,m=i.length;l<m;l+=2)a.measureText(k+i[l]+i[l+1]).width>this.lineWidth?(b&&this._drawTextLine(a,k,e*d),e++,k=i[l+1]):k+=i[l]+i[l+1];b&&this._drawTextLine(a,k,e*d)}e++}return e};b._drawTextLine=function(a,b,c){this.outline?a.strokeText(b,0,c,this.maxWidth||65535):a.fillText(b,0,c,this.maxWidth||65535)};createjs.Text=c})();this.createjs=this.createjs||{};
(function(){var c=function(){throw"SpriteSheetUtils cannot be instantiated";};c._workingCanvas=createjs.createCanvas?createjs.createCanvas():document.createElement("canvas");c._workingContext=c._workingCanvas.getContext("2d");c.addFlippedFrames=function(b,a,j,h){if(a||j||h){var d=0;a&&c._flip(b,++d,true,false);j&&c._flip(b,++d,false,true);h&&c._flip(b,++d,true,true)}};c.extractFrame=function(b,a){isNaN(a)&&(a=b.getAnimation(a).frames[0]);var j=b.getFrame(a);if(!j)return null;var h=j.rect,d=c._workingCanvas;
d.width=h.width;d.height=h.height;c._workingContext.drawImage(j.image,h.x,h.y,h.width,h.height,0,0,h.width,h.height);j=new Image;j.src=d.toDataURL("image/png");return j};c.mergeAlpha=function(b,a,c){c||(c=createjs.createCanvas?createjs.createCanvas():document.createElement("canvas"));c.width=Math.max(a.width,b.width);c.height=Math.max(a.height,b.height);var h=c.getContext("2d");h.save();h.drawImage(b,0,0);h.globalCompositeOperation="destination-in";h.drawImage(a,0,0);h.restore();return c};c._flip=
function(b,a,j,h){for(var d=b._images,e=c._workingCanvas,f=c._workingContext,g=d.length/a,i=0;i<g;i++){var k=d[i];k.__tmp=i;e.width=0;e.width=k.width;e.height=k.height;f.setTransform(j?-1:1,0,0,h?-1:1,j?k.width:0,h?k.height:0);f.drawImage(k,0,0);var l=new Image;l.src=e.toDataURL("image/png");l.width=k.width;l.height=k.height;d.push(l)}f=b._frames;e=f.length/a;for(i=0;i<e;i++){var k=f[i],m=k.rect.clone(),l=d[k.image.__tmp+g*a],n={image:l,rect:m,regX:k.regX,regY:k.regY};if(j)m.x=l.width-m.x-m.width,
n.regX=m.width-k.regX;if(h)m.y=l.height-m.y-m.height,n.regY=m.height-k.regY;f.push(n)}j="_"+(j?"h":"")+(h?"v":"");h=b._animations;b=b._data;d=h.length/a;for(i=0;i<d;i++){f=h[i];k=b[f];g={name:f+j,frequency:k.frequency,next:k.next,frames:[]};k.next&&(g.next+=j);f=k.frames;k=0;for(l=f.length;k<l;k++)g.frames.push(f[k]+e*a);b[g.name]=g;h.push(g.name)}};createjs.SpriteSheetUtils=c})();this.createjs=this.createjs||{};
...
i.width=this._getSize(e,this.maxWidth);i.height=this._getSize(d,this.maxHeight);this._data.images[f]=i;g.h||(e=d=0,f++)}}};b._getSize=function(a,b){for(var c=4;Math.pow(2,++c)<a;);return Math.min(b,Math.pow(2,c))};b._fillRow=function(a,b,h,d,e){var f=this.maxWidth,g=this.maxHeight-b,i=e;b+=e;for(var k=0,l=a.length-1;l>=0;l--){var m=a[l],n=this._scale*m.scale,o=m.sourceRect,q=m.source,p=Math.floor(n*o.x-e),s=Math.floor(n*o.y-e),r=Math.ceil(n*o.height+e*2),o=Math.ceil(n*o.width+e*2);if(o>f)throw c.ERR_DIMENSIONS;
if(!(r>g||i+o>f))m.img=h,m.rect=new createjs.Rectangle(i,b,o,r),k=k||r,a.splice(l,1),d[m.index]=[i,b,o,r,h,Math.round(-p+n*q.regX-e),Math.round(-s+n*q.regY-e)],i+=o}return{w:i,h:k}};b._endBuild=function(){this.spriteSheet=new createjs.SpriteSheet(this._data);this._data=null;this._callback&&this._callback(this)};b._run=function(){for(var a=(new Date).getTime()+this._timeSlice,b=false;a>(new Date).getTime();)if(!this._drawNext()){b=true;break}if(b)this._endBuild();else{var c=this;this._timerID=setTimeout(function(){c._run()},
...
(function(){var c=function(a,b,c,d,e,f,g){this.initialize(a,b,c,d,e,f,g)},b=c.prototype;b.target=null;b.overLabel=null;b.outLabel=null;b.pressLabel=null;b.play=false;b._isPressed=false;b.initialize=function(a,b,c,d,e,f,g){this.target=a;this.overLabel=c==null?"over":c;this.outLabel=b==null?"out":b;this.pressLabel=d==null?"press":d;this.play=e;a.cursor="pointer";this.setEnabled(true);this._handleEvt({});if(f){if(g)f.actionsEnabled=false,f.gotoAndStop(g);a.hitArea=f}};b.setEnabled=function(a){var b=
this.target,c=this;if(b.addEventListener){var d=c._handleEvt;a?(b.addEventListener("mouseOver",d,c),b.addEventListener("mouseOut",d,c),b.addEventListener("press",d,c),b.addEventListener("click",d,c)):(b.removeEventListener("mouseOver",d,c),b.removeEventListener("mouseOut",d,c),b.removeEventListener("press",d,c),b.removeEventListener("click",d,c))}else b.onMouseOver=b.onMouseOut=a?function(a){c._handleEvt(a)}:null};b.toString=function(){return"[ButtonHelper]"};b._handleEvt=function(a){var b=a.type==
"mouseOver"&&!this._isPressed||a.type=="click"?this.overLabel:a.type=="mouseOver"&&this._isPressed||a.type=="press"?this.pressLabel:this.outLabel;if(a.type=="press"){var c=this;this._isPressed=true;a.addEventListener?a.addEventListener("mouseUp",c._handleEvt,c):a.onMouseMove=function(a){c._handleEvt(a)}}else if(a.type=="mouseUp"){this._isPressed=false;return}this.play?this.target.gotoAndPlay(b):this.target.gotoAndStop(b)};createjs.ButtonHelper=c})();this.createjs=this.createjs||{};
(function(){var c=function(){throw"Touch cannot be instantiated";};c.isSupported=function(){return"ontouchstart"in window||window.navigator.msPointerEnabled};c.enable=function(b,a,j){if(!b||!b.canvas||!c.isSupported())return false;b.__touch={pointers:{},multitouch:!a,preventDefault:!j,count:0};"ontouchstart"in window?c._IOS_enable(b):window.navigator.msPointerEnabled&&c._IE_enable(b);return true};c.disable=function(b){b&&("ontouchstart"in window?c._IOS_disable(b):window.navigator.msPointerEnabled&&c._IE_disable(b))};
c._IOS_enable=function(b){var a=b.canvas,j=b.__touch.f=function(a){c._IOS_handleEvent(b,a)};a.addEventListener("touchstart",j,false);a.addEventListener("touchmove",j,false);a.addEventListener("touchend",j,false);a.addEventListener("touchcancel",j,false)};c._IOS_disable=function(b){var a=b.canvas;if(a)b=b.__touch.f,a.removeEventListener("touchstart",b,false),a.removeEventListener("touchmove",b,false),a.removeEventListener("touchend",b,false),a.removeEventListener("touchcancel",b,false)};c._IOS_handleEvent=
function(b,a){if(b){b.__touch.preventDefault&&a.preventDefault&&a.preventDefault();for(var c=a.changedTouches,h=a.type,d=0,e=c.length;d<e;d++){var f=c[d],g=f.identifier;f.target==b.canvas&&(h=="touchstart"?this._handleStart(b,g,a,f.pageX,f.pageY):h=="touchmove"?this._handleMove(b,g,a,f.pageX,f.pageY):(h=="touchend"||h=="touchcancel")&&this._handleEnd(b,g,a))}}};c._IE_enable=function(b){var a=b.canvas,j=b.__touch.f=function(a){c._IE_handleEvent(b,a)};a.addEventListener("MSPointerDown",j,false);window.addEventListener("MSPointerMove",
j,false);window.addEventListener("MSPointerUp",j,false);window.addEventListener("MSPointerCancel",j,false);if(b.__touch.preventDefault)a.style.msTouchAction="none";b.__touch.activeIDs={}};c._IE_disable=function(b){var a=b.__touch.f;window.removeEventListener("MSPointerMove",a,false);window.removeEventListener("MSPointerUp",a,false);window.removeEventListener("MSPointerCancel",a,false);b.canvas&&b.canvas.removeEventListener("MSPointerDown",a,false)};c._IE_handleEvent=function(b,a){if(b){b.__touch.preventDefault&&
