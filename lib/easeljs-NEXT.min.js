...
1&&c._tick()};c._handleTimeout=function(){c.timeoutID=null;c._setupTick();c._tick()};c._setupTick=function(){if(!(c._rafActive||c.timeoutID!=null)){if(c.useRAF){var a=i.requestAnimationFrame||i.webkitRequestAnimationFrame||i.mozRequestAnimationFrame||i.oRequestAnimationFrame||i.msRequestAnimationFrame;if(a){a(c._handleAF,c.animationTarget);c._rafActive=true;return}}c.timeoutID=setTimeout(c._handleTimeout,c._interval)}};c._tick=function(){c._ticks++;var a=c._getTime(),b=a-c._lastTime,p=c._paused;p&&
(c._pausedTickers++,c._pausedTime+=b);c._lastTime=a;for(var g=c._pauseable,e=c._listeners.slice(),d=e?e.length:0,f=0;f<d;f++){var h=e[f];h==null||p&&g[f]||(h.tick?h.tick(b,p):h instanceof Function&&h(b,p))}for(c._tickTimes.unshift(c._getTime()-a);c._tickTimes.length>100;)c._tickTimes.pop();for(c._times.unshift(a);c._times.length>100;)c._times.pop()};c._getTime=function(){return(new Date).getTime()};i.Ticker=c})(window);(function(i){var c=function(b,a,g,c,d){this.initialize(b,a,g,c,d)},a=c.prototype;a.stageX=0;a.stageY=0;a.type=null;a.nativeEvent=null;a.onMouseMove=null;a.onMouseUp=null;a.target=null;a.initialize=function(b,a,g,c,d){this.type=b;this.stageX=a;this.stageY=g;this.target=c;this.nativeEvent=d};a.clone=function(){return new c(this.type,this.stageX,this.stageY,this.target,this.nativeEvent)};a.toString=function(){return"[MouseEvent (type="+this.type+" stageX="+this.stageX+" stageY="+this.stageY+")]"};i.MouseEvent=
c})(window);(function(i){var c=function(b,a,g,c,d,f){this.initialize(b,a,g,c,d,f)},a=c.prototype;c.identity=null;c.DEG_TO_RAD=Math.PI/180;a.a=1;a.b=0;a.c=0;a.d=1;a.tx=0;a.ty=0;a.alpha=1;a.shadow=null;a.compositeOperation=null;a.initialize=function(b,a,g,c,d,f){if(b!=null)this.a=b;this.b=a||0;this.c=g||0;if(c!=null)this.d=c;this.tx=d||0;this.ty=f||0;return this};a.prepend=function(b,a,g,c,d,f){var h=this.tx;if(b!=1||a!=0||g!=0||c!=1){var l=this.a,j=this.c;this.a=l*b+this.b*g;this.b=l*a+this.b*c;this.c=j*b+this.d*
g;this.d=j*a+this.d*c}this.tx=h*b+this.ty*g+d;this.ty=h*a+this.ty*c+f;return this};a.append=function(b,a,g,c,d,f){var h=this.a,l=this.b,j=this.c,k=this.d;this.a=b*h+a*j;this.b=b*l+a*k;this.c=g*h+c*j;this.d=g*l+c*k;this.tx=d*h+f*j+this.tx;this.ty=d*l+f*k+this.ty;return this};a.prependMatrix=function(b){this.prepend(b.a,b.b,b.c,b.d,b.tx,b.ty);this.prependProperties(b.alpha,b.shadow,b.compositeOperation);return this};a.appendMatrix=function(b){this.append(b.a,b.b,b.c,b.d,b.tx,b.ty);this.appendProperties(b.alpha,
b.shadow,b.compositeOperation);return this};a.prependTransform=function(b,a,g,e,d,f,h,l,j){if(d%360)var k=d*c.DEG_TO_RAD,d=Math.cos(k),k=Math.sin(k);else d=1,k=0;if(l||j)this.tx-=l,this.ty-=j;f||h?(f*=c.DEG_TO_RAD,h*=c.DEG_TO_RAD,this.prepend(d*g,k*g,-k*e,d*e,0,0),this.prepend(Math.cos(h),Math.sin(h),-Math.sin(f),Math.cos(f),b,a)):this.prepend(d*g,k*g,-k*e,d*e,b,a);return this};a.appendTransform=function(b,a,g,e,d,f,h,l,j){if(d%360)var k=d*c.DEG_TO_RAD,d=Math.cos(k),k=Math.sin(k);else d=1,k=0;f||
h?(f*=c.DEG_TO_RAD,h*=c.DEG_TO_RAD,this.append(Math.cos(h),Math.sin(h),-Math.sin(f),Math.cos(f),b,a),this.append(d*g,k*g,-k*e,d*e,0,0)):this.append(d*g,k*g,-k*e,d*e,b,a);if(l||j)this.tx-=l*this.a+j*this.c,this.ty-=l*this.b+j*this.d;return this};a.rotate=function(b){var a=Math.cos(b),b=Math.sin(b),g=this.a,c=this.c,d=this.tx;this.a=g*a-this.b*b;this.b=g*b+this.b*a;this.c=c*a-this.d*b;this.d=c*b+this.d*a;this.tx=d*a-this.ty*b;this.ty=d*b+this.ty*a;return this};a.skew=function(b,a){b*=c.DEG_TO_RAD;a*=
...
d,f,h,l,j){this._active&&this._newPath();e=this._ctx.createRadialGradient(e,d,f,h,l,j);d=0;for(f=b.length;d<f;d++)e.addColorStop(a[d],b[d]);this._strokeInstructions=[new c(this._setProp,["strokeStyle",e],false)];return this};b.beginBitmapStroke=function(b,a){this._active&&this._newPath();var e=this._ctx.createPattern(b,a||"");this._strokeInstructions=[new c(this._setProp,["strokeStyle",e],false)];return this};b.endStroke=function(){this.beginStroke();return this};b.curveTo=b.quadraticCurveTo;b.drawRect=
b.rect;b.drawRoundRect=function(b,a,c,d,f){this.drawRoundRectComplex(b,a,c,d,f,f,f,f);return this};b.drawRoundRectComplex=function(b,a,e,d,f,h,l,j){this._dirty=this._active=true;var k=Math.PI,i=this._ctx.arc,m=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[b+f,a]),new c(m,[b+e-h,a]),h>=0?new c(i,[b+e-h,a+h,h,-k/2,0]):new c(i,[b+e,a,-h,k,k/2,true]),new c(m,[b+e,a+d-l]),j>=0?new c(i,[b+e-l,a+d-l,l,0,k/2]):new c(i,[b+e,a+d,-l,-k/2,k,true]),new c(m,[b+j,a+d]),j>=0?new c(i,[b+j,
a+d-j,j,k/2,k]):new c(i,[b,a+d,-j,0,-k/2,true]),new c(m,[b,a+f]),f>=0?new c(i,[b+f,a+f,f,k,-k/2]):new c(i,[b,a,-f,k/2,0,true]));return this};b.drawCircle=function(b,a,c){this.arc(b,a,c,0,Math.PI*2);return this};b.drawEllipse=function(b,a,e,d){this._dirty=this._active=true;var f=e/2*0.5522848,h=d/2*0.5522848,l=b+e,j=a+d,e=b+e/2,d=a+d/2;this._activeInstructions.push(new c(this._ctx.moveTo,[b,d]),new c(this._ctx.bezierCurveTo,[b,d-h,e-f,a,e,a]),new c(this._ctx.bezierCurveTo,[e+f,a,l,d-h,l,d]),new c(this._ctx.bezierCurveTo,
[l,d+h,e+f,j,e,j]),new c(this._ctx.bezierCurveTo,[e-f,j,b,d+h,b,d]));return this};b.drawPolyStar=function(b,a,e,d,f,h){this._dirty=this._active=true;f==null&&(f=0);f=1-f;h==null?h=0:h/=180/Math.PI;var l=Math.PI/d;this._activeInstructions.push(new c(this._ctx.moveTo,[b+Math.cos(h)*e,a+Math.sin(h)*e]));for(var j=0;j<d;j++)h+=l,f!=1&&this._activeInstructions.push(new c(this._ctx.lineTo,[b+Math.cos(h)*e*f,a+Math.sin(h)*e*f])),h+=l,this._activeInstructions.push(new c(this._ctx.lineTo,[b+Math.cos(h)*e,
a+Math.sin(h)*e]));return this};b.decodePath=function(b){for(var c=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],e=[2,2,4,6],d=0,f=b.length,h=[],l=0,j=0,k=a.BASE_64;d<f;){var i=k[b.charAt(d)],m=i>>3,q=c[m];if(!q||i&3)throw"bad path data";var r=e[m];m||(l=j=0);h.length=0;d++;i=(i>>2&1)+2;for(m=0;m<r;m++){var n=k[b.charAt(d)],s=n>>5?-1:1,n=(n&31)<<6|k[b.charAt(d+1)];i==3&&(n=n<<6|k[b.charAt(d+2)]);n=s*n/10;m%2?l=n+=l:j=n+=j;h[m]=n;d+=i}q.apply(this,h)}return this};b.clone=function(){var b=
...
function(b,a,c,e,d,f,h,l,j){this.x=b||0;this.y=a||0;this.scaleX=c==null?1:c;this.scaleY=e==null?1:e;this.rotation=d||0;this.skewX=f||0;this.skewY=h||0;this.regX=l||0;this.regY=j||0};a.getConcatenatedMatrix=function(b){b?b.identity():b=new Matrix2D;for(var a=this;a!=null;)b.prependTransform(a.x,a.y,a.scaleX,a.scaleY,a.rotation,a.skewX,a.skewY,a.regX,a.regY),b.prependProperties(a.alpha,a.shadow,a.compositeOperation),a=a.parent;return b};a.hitTest=function(b,a){var g=c._hitTestContext,e=c._hitTestCanvas;
g.setTransform(1,0,0,1,-b,-a);this.draw(g);g=this._testHit(g);e.width=0;e.width=1;return g};a.clone=function(){var b=new c;this.cloneProps(b);return b};a.toString=function(){return"[DisplayObject (name="+this.name+")]"};a.cloneProps=function(b){b.alpha=this.alpha;b.name=this.name;b.regX=this.regX;b.regY=this.regY;b.rotation=this.rotation;b.scaleX=this.scaleX;b.scaleY=this.scaleY;b.shadow=this.shadow;b.skewX=this.skewX;b.skewY=this.skewY;b.visible=this.visible;b.x=this.x;b.y=this.y;b.mouseEnabled=
this.mouseEnabled;b.compositeOperation=this.compositeOperation;if(this.cacheCanvas)b.cacheCanvas=this.cacheCanvas.cloneNode(true),b.cacheCanvas.getContext("2d").putImageData(this.cacheCanvas.getContext("2d").getImageData(0,0,this.cacheCanvas.width,this.cacheCanvas.height),0,0)};a._applyShadow=function(b,a){a=a||Shadow.identity;b.shadowColor=a.color;b.shadowOffsetX=a.offsetX;b.shadowOffsetY=a.offsetY;b.shadowBlur=a.blur};a._tick=function(b){if(this.onTick)this.onTick(b)};a._testHit=function(b){try{var a=
b.getImageData(0,0,1,1).data[3]>1}catch(g){if(!c.suppressCrossDomainErrors)throw"An error has occured. This is most likely due to security restrictions on reading canvas pixel data with local or cross-domain images.";}return a};a._applyFilters=function(){if(this.filters&&this.filters.length!=0&&this.cacheCanvas)for(var b=this.filters.length,a=this.cacheCanvas.getContext("2d"),c=this.cacheCanvas.width,e=this.cacheCanvas.height,d=0;d<b;d++)this.filters[d].applyFilter(a,0,0,c,e)};a._getMatrix=function(b){var a=
this._matrix;b?a.reinitialize(b.a,b.b,b.c,b.d,b.tx,b.ty):a.identity();return a.appendTransform(this.x,this.y,this.scaleX,this.scaleY,this.rotation,this.skewX,this.skewY,this.regX,this.regY)};i.DisplayObject=c})(window);(function(i){var c=function(){this.initialize()},a=c.prototype=new DisplayObject;a.children=null;a.DisplayObject_initialize=a.initialize;a.initialize=function(){this.DisplayObject_initialize();this.children=[]};a.isVisible=function(){return this.visible&&this.alpha>0&&this.children.length&&this.scaleX!=0&&this.scaleY!=0};a.DisplayObject_draw=a.draw;a.draw=function(b,a,c){if(this.DisplayObject_draw(b,a))return true;for(var a=this._getMatrix(c),c=this.children.slice(0),e=0,d=c.length;e<d;e++){var f=
c[e];f.isVisible()&&(b.save(),f.updateContext(b),f.draw(b,false,a),b.restore())}return true};a.addChild=function(b){if(b==null)return b;var a=arguments.length;if(a>1){for(var c=0;c<a;c++)this.addChild(arguments[c]);return arguments[a-1]}b.parent&&b.parent.removeChild(b);b.parent=this;this.children.push(b);return b};a.addChildAt=function(b,a){var c=arguments.length;if(c>2){for(var a=arguments[e-1],e=0;e<c-1;e++)this.addChildAt(arguments[e],a+e);return arguments[c-2]}b.parent&&b.parent.removeChild(b);
b.parent=this;this.children.splice(a,0,b);return b};a.removeChild=function(b){var a=arguments.length;if(a>1){for(var c=true,e=0;e<a;e++)c=c&&this.removeChild(arguments[e]);return c}return this.removeChildAt(this.children.indexOf(b))};a.removeChildAt=function(b){var a=arguments.length;if(a>1){for(var c=[],e=0;e<a;e++)c[e]=arguments[e];c.sort(function(b,a){return a-b});for(var d=true,e=0;e<a;e++)d=d&&this.removeChildAt(c[e]);return d}if(b<0||b>this.children.length-1)return false;a=this.children[b];
if(a!=null)a.parent=null;this.children.splice(b,1);return true};a.removeAllChildren=function(){for(var b=this.children;b.length;)b.pop().parent=null};a.getChildAt=function(b){return this.children[b]};a.sortChildren=function(b){this.children.sort(b)};a.getChildIndex=function(b){return this.children.indexOf(b)};a.getNumChildren=function(){return this.children.length};a.swapChildrenAt=function(b,a){var c=this.children,e=c[b],d=c[a];e&&d&&(c[b]=d,c[a]=e)};a.swapChildren=function(b,a){for(var c=this.children,
e,d,f=0,h=c.length;f<h;f++)if(c[f]==b&&(e=f),c[f]==a&&(d=f),e!=null&&d!=null)break;f!=h&&(c[e]=a,c[d]=b)};a.setChildIndex=function(b,a){for(var c=this.children,e=0,d=c.length;e<d;e++)if(c[e]==b)break;e==d||a<0||a>d||e==a||(c.splice(a,1),a<e&&e--,c.splice(b,e,0))};a.contains=function(b){for(;b;){if(b==this)return true;b=b.parent}return false};a.hitTest=function(b,a){return this.getObjectUnderPoint(b,a)!=null};a.getObjectsUnderPoint=function(b,a){var c=[],e=this.localToGlobal(b,a);this._getObjectsUnderPoint(e.x,
e.y,c);return c};a.getObjectUnderPoint=function(b,a){var c=this.localToGlobal(b,a);return this._getObjectsUnderPoint(c.x,c.y)};a.clone=function(b){var a=new c;this.cloneProps(a);if(b)for(var g=a.children=[],e=0,d=this.children.length;e<d;e++){var f=this.children[e].clone(b);f.parent=a;g.push(f)}return a};a.toString=function(){return"[Container (name="+this.name+")]"};a._tick=function(b){for(var a=this.children.length-1;a>=0;a--){var c=this.children[a];c._tick&&c._tick(b)}if(this.onTick)this.onTick(b)};
a._getObjectsUnderPoint=function(b,a,g,e){var d=DisplayObject._hitTestContext,f=DisplayObject._hitTestCanvas,h=this._matrix,l=e&1&&(this.onPress||this.onClick||this.onDoubleClick)||e&2&&(this.onMouseOver||this.onMouseOut);if(this.cacheCanvas)if(this.getConcatenatedMatrix(h),d.setTransform(h.a,h.b,h.c,h.d,h.tx-b,h.ty-a),d.globalAlpha=h.alpha,this.draw(d),this._testHit(d)){if(f.width=0,f.width=1,l)return this}else return null;for(var j=this.children.length-1;j>=0;j--){var k=this.children[j];if(k.isVisible()&&
k.mouseEnabled)if(k instanceof c)if(l){if(k=k._getObjectsUnderPoint(b,a))return this}else{if(k=k._getObjectsUnderPoint(b,a,g,e),!g&&k)return k}else if(!e||l||e&1&&(k.onPress||k.onClick||k.onDoubleClick)||e&2&&(k.onMouseOver||k.onMouseOut))if(k.getConcatenatedMatrix(h),d.setTransform(h.a,h.b,h.c,h.d,h.tx-b,h.ty-a),d.globalAlpha=h.alpha,k.draw(d),this._testHit(d))if(f.width=0,f.width=1,l)return this;else if(g)g.push(k);else return k}return null};i.Container=c})(window);(function(i){var c=function(b){this.initialize(b)},a=c.prototype=new Container;c._snapToPixelEnabled=false;a.autoClear=true;a.canvas=null;a.mouseX=null;a.mouseY=null;a.onMouseMove=null;a.onMouseUp=null;a.onMouseDown=null;a.snapToPixelEnabled=false;a.mouseInBounds=false;a.tickOnUpdate=true;a._activeMouseEvent=null;a._activeMouseTarget=null;a._mouseOverIntervalID=null;a._mouseOverX=0;a._mouseOverY=0;a._mouseOverTarget=null;a.Container_initialize=a.initialize;a.initialize=function(b){this.Container_initialize();
...
this.outline;a.lineHeight=this.lineHeight;a.lineWidth=this.lineWidth};a._getWorkingContext=function(){var a=c._workingContext;a.font=this.font;a.textAlign=this.textAlign||"start";a.textBaseline=this.textBaseline||"alphabetic";return a};a._drawText=function(a){var c=!!a;c||(a=this._getWorkingContext());for(var g=String(this.text).split(/(?:\r\n|\r|\n)/),e=this.lineHeight||this.getMeasuredLineHeight(),d=0,f=0,h=g.length;f<h;f++){var l=a.measureText(g[f]).width;if(this.lineWidth==null||l<this.lineWidth)c&&
this._drawTextLine(a,g[f],d*e);else{for(var l=g[f].split(/(\s)/),j=l[0],k=1,i=l.length;k<i;k+=2)a.measureText(j+l[k]+l[k+1]).width>this.lineWidth?(c&&this._drawTextLine(a,j,d*e),d++,j=l[k+1]):j+=l[k]+l[k+1];c&&this._drawTextLine(a,j,d*e)}d++}return d};a._drawTextLine=function(a,c,g){this.outline?a.strokeText(c,0,g,this.maxWidth||65535):a.fillText(c,0,g,this.maxWidth||65535)};i.Text=c})(window);(function(i){var c=function(){throw"SpriteSheetUtils cannot be instantiated";};c._workingCanvas=document.createElement("canvas");c._workingContext=c._workingCanvas.getContext("2d");c.addFlippedFrames=function(a,b,i,g){if(b||i||g){var e=0;b&&c._flip(a,++e,true,false);i&&c._flip(a,++e,false,true);g&&c._flip(a,++e,true,true)}};c.extractFrame=function(a,b){isNaN(b)&&(b=a.getAnimation(b).frames[0]);var i=a.getFrame(b);if(!i)return null;var g=i.rect,e=c._workingCanvas;e.width=g.width;e.height=g.height;
c._workingContext.drawImage(i.image,g.x,g.y,g.width,g.height,0,0,g.width,g.height);i=new Image;i.src=e.toDataURL("image/png");return i};c._flip=function(a,b,i,g){for(var e=a._images,d=c._workingCanvas,f=c._workingContext,h=e.length/b,l=0;l<h;l++){var j=e[l];j.__tmp=l;d.width=j.width;d.height=j.height;f.setTransform(i?-1:1,0,0,g?-1:1,i?j.width:0,g?j.height:0);f.drawImage(j,0,0);var k=new Image;k.src=d.toDataURL("image/png");k.width=j.width;k.height=j.height;e.push(k)}f=a._frames;d=f.length/b;for(l=
0;l<d;l++){var j=f[l],o=j.rect.clone(),k=e[j.image.__tmp+h*b],m={image:k,rect:o,regX:j.regX,regY:j.regY};if(i)o.x=k.width-o.x-o.width,m.regX=o.width-j.regX;if(g)o.y=k.height-o.y-o.height,m.regY=o.height-j.regY;f.push(m)}i="_"+(i?"h":"")+(g?"v":"");g=a._animations;a=a._data;e=g.length/b;for(l=0;l<e;l++){f=g[l];j=a[f];h={name:f+i,frequency:j.frequency,next:j.next,frames:[]};j.next&&(h.next+=i);f=j.frames;j=0;for(k=f.length;j<k;j++)h.frames.push(f[j]+d*b);a[h.name]=h;g.push(h.name)}};i.SpriteSheetUtils=
c})(window);(function(i){var c=function(a){this.initialize(a)},a=c.prototype=new DisplayObject;a.htmlElement=null;a._style=null;a.DisplayObject_initialize=a.initialize;a.initialize=function(a){typeof a=="string"&&(a=document.getElementById(a));this.DisplayObject_initialize();this.mouseEnabled=false;if(this.htmlElement=a)this._style=a.style,this._style.position="absolute",this._style.transformOrigin=this._style.webkitTransformOrigin=this._style.msTransformOrigin=this._style.MozTransformOrigin="0% 0%"};a.isVisible=
function(){return this.htmlElement!=null};a.draw=function(a,c,g){if(this.htmlElement!=null)return c=this._getMatrix(g),g=this.htmlElement,g.style.opacity=""+a.globalAlpha*this.alpha,g.style.visibility=this.visible?"visible":"hidden",g.style.transform=g.style.webkitTransform=g.style.oTransform=g.style.msTransform=["matrix("+c.a,c.b,c.c,c.d,c.tx,c.ty+")"].join(","),g.style.MozTransform=["matrix("+c.a,c.b,c.c,c.d,c.tx+"px",c.ty+"px)"].join(","),true};a.cache=function(){};a.uncache=function(){};a.updateCache=
...
a._handleTouchMoveListener=null};c._findPrimaryTouch=function(a,b){for(var c=b.length,g=0;g<c;g++){var e=b[g];if(e.identifier==a._primaryTouchId)return e}return null};i.Touch=c})(window);
