...
d,f,g,l,j){this._active&&this._newPath();e=this._ctx.createRadialGradient(e,d,f,g,l,j);d=0;for(f=b.length;d<f;d++)e.addColorStop(a[d],b[d]);this._strokeInstructions=[new c(this._setProp,["strokeStyle",e],false)];return this};b.beginBitmapStroke=function(b,a){this._active&&this._newPath();var e=this._ctx.createPattern(b,a||"");this._strokeInstructions=[new c(this._setProp,["strokeStyle",e],false)];return this};b.endStroke=function(){this.beginStroke();return this};b.curveTo=b.quadraticCurveTo;b.drawRect=
b.rect;b.drawRoundRect=function(b,a,c,d,f){this.drawRoundRectComplex(b,a,c,d,f,f,f,f);return this};b.drawRoundRectComplex=function(b,a,e,d,f,g,l,j){this._dirty=this._active=true;var k=Math.PI,i=this._ctx.arc,m=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[b+f,a]),new c(m,[b+e-g,a]),g>=0?new c(i,[b+e-g,a+g,g,-k/2,0]):new c(i,[b+e,a,-g,k,k/2,true]),new c(m,[b+e,a+d-l]),j>=0?new c(i,[b+e-l,a+d-l,l,0,k/2]):new c(i,[b+e,a+d,-l,-k/2,k,true]),new c(m,[b+j,a+d]),j>=0?new c(i,[b+j,
a+d-j,j,k/2,k]):new c(i,[b,a+d,-j,0,-k/2,true]),new c(m,[b,a+f]),f>=0?new c(i,[b+f,a+f,f,k,-k/2]):new c(i,[b,a,-f,k/2,0,true]));return this};b.drawCircle=function(b,a,c){this.arc(b,a,c,0,Math.PI*2);return this};b.drawEllipse=function(b,a,e,d){this._dirty=this._active=true;var f=e/2*0.5522848,g=d/2*0.5522848,l=b+e,j=a+d,e=b+e/2,d=a+d/2;this._activeInstructions.push(new c(this._ctx.moveTo,[b,d]),new c(this._ctx.bezierCurveTo,[b,d-g,e-f,a,e,a]),new c(this._ctx.bezierCurveTo,[e+f,a,l,d-g,l,d]),new c(this._ctx.bezierCurveTo,
[l,d+g,e+f,j,e,j]),new c(this._ctx.bezierCurveTo,[e-f,j,b,d+g,b,d]));return this};b.drawPolyStar=function(b,a,e,d,f,g){this._dirty=this._active=true;f==null&&(f=0);f=1-f;g==null?g=0:g/=180/Math.PI;var l=Math.PI/d;this._activeInstructions.push(new c(this._ctx.moveTo,[b+Math.cos(g)*e,a+Math.sin(g)*e]));for(var j=0;j<d;j++)g+=l,f!=1&&this._activeInstructions.push(new c(this._ctx.lineTo,[b+Math.cos(g)*e*f,a+Math.sin(g)*e*f])),g+=l,this._activeInstructions.push(new c(this._ctx.lineTo,[b+Math.cos(g)*e,
a+Math.sin(g)*e]));return this};b.decodePath=function(b){for(var c=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],e=[2,2,4,6],d=0,f=b.length,g=[],l=0,j=0,k=a.BASE_64;d<f;){var i=k[b.charAt(d)],m=i>>3,q=c[m];if(!q||i&3)throw"bad path data";var r=e[m];m||(l=j=0);g.length=0;d++;i=(i>>2&1)+2;for(m=0;m<r;m++){var n=k[b.charAt(d)],s=n>>5?-1:1,n=(n&31)<<6|k[b.charAt(d+1)];i==3&&(n=n<<6|k[b.charAt(d+2)]);n=s*n/10;m%2?l=n+=l:j=n+=j;g[m]=n;d+=i}q.apply(this,g)}return this};b.clone=function(){var b=
...
1);return true};a.removeAllChildren=function(){for(var b=this.children;b.length;)b.pop().parent=null};a.getChildAt=function(b){return this.children[b]};a.sortChildren=function(b){this.children.sort(b)};a.getChildIndex=function(b){return this.children.indexOf(b)};a.getNumChildren=function(){return this.children.length};a.swapChildrenAt=function(b,a){var c=this.children,e=c[b],d=c[a];e&&d&&(c[b]=d,c[a]=e)};a.swapChildren=function(b,a){for(var c=this.children,e,d,f=0,g=c.length;f<g;f++)if(c[f]==b&&(e=
...
function(b,a){var c=this.localToGlobal(b,a);return this._getObjectsUnderPoint(c.x,c.y)};a.clone=function(b){var a=new c;this.cloneProps(a);if(b)for(var h=a.children=[],e=0,d=this.children.length;e<d;e++){var f=this.children[e].clone(b);f.parent=a;h.push(f)}return a};a.toString=function(){return"[Container (name="+this.name+")]"};a._tick=function(b){for(var a=this.children.length-1;a>=0;a--){var c=this.children[a];c._tick&&c._tick(b)}if(this.onTick)this.onTick(b)};a._getObjectsUnderPoint=function(b,
a,h,e){var d=DisplayObject._hitTestContext,f=DisplayObject._hitTestCanvas,g=this._matrix,l=e&1&&(this.onPress||this.onClick||this.onDoubleClick)||e&2&&(this.onMouseOver||this.onMouseOut);if(this.cacheCanvas)if(this.getConcatenatedMatrix(g),d.setTransform(g.a,g.b,g.c,g.d,g.tx-b,g.ty-a),d.globalAlpha=g.alpha,this.draw(d),this._testHit(d)){if(f.width=0,f.width=1,l)return this}else return null;for(var j=this.children.length-1;j>=0;j--){var k=this.children[j];if(k.isVisible()&&k.mouseEnabled)if(k instanceof
c)if(l){if(k=k._getObjectsUnderPoint(b,a))return this}else{if(k=k._getObjectsUnderPoint(b,a,h,e),!h&&k)return k}else if(!e||l||e&1&&(k.onPress||k.onClick||k.onDoubleClick)||e&2&&(k.onMouseOver||k.onMouseOut))if(k.getConcatenatedMatrix(g),d.setTransform(g.a,g.b,g.c,g.d,g.tx-b,g.ty-a),d.globalAlpha=g.alpha,k.draw(d),this._testHit(d))if(f.width=0,f.width=1,l)return this;else if(h)h.push(k);else return k}return null};i.Container=c})(window);(function(i){var c=function(b){this.initialize(b)},a=c.prototype=new Container;c._snapToPixelEnabled=false;a.autoClear=true;a.canvas=null;a.mouseX=null;a.mouseY=null;a.onMouseMove=null;a.onMouseUp=null;a.onMouseDown=null;a.snapToPixelEnabled=false;a.mouseInBounds=false;a.tickOnUpdate=true;a._activeMouseEvent=null;a._activeMouseTarget=null;a._mouseOverIntervalID=null;a._mouseOverX=0;a._mouseOverY=0;a._mouseOverTarget=null;a.Container_initialize=a.initialize;a.initialize=function(b){this.Container_initialize();
...
a.toDataURL=function(b,a){a||(a="image/png");var c=this.canvas.getContext("2d"),e=this.canvas.width,d=this.canvas.height,f;if(b){f=c.getImageData(0,0,e,d);var g=c.globalCompositeOperation;c.globalCompositeOperation="destination-over";c.fillStyle=b;c.fillRect(0,0,e,d)}var l=this.canvas.toDataURL(a);if(b)c.clearRect(0,0,e,d),c.putImageData(f,0,0),c.globalCompositeOperation=g;return l};a.enableMouseOver=function(b){if(this._mouseOverIntervalID)clearInterval(this._mouseOverIntervalID),this._mouseOverIntervalID=
...
this.graphics.clone():this.graphics);this.cloneProps(a);return a};a.toString=function(){return"[Shape (name="+this.name+")]"};i.Shape=c})(window);(function(i){var c=function(a,c,h){this.initialize(a,c,h)},a=c.prototype=new DisplayObject;c._workingContext=document.createElement("canvas").getContext("2d");a.text="";a.font=null;a.color=null;a.textAlign=null;a.textBaseline=null;a.maxWidth=null;a.outline=false;a.lineHeight=0;a.lineWidth=null;a.DisplayObject_initialize=a.initialize;a.initialize=function(a,c,h){this.DisplayObject_initialize();this.text=a;this.font=c;this.color=h?h:"#000"};a.isVisible=function(){return Boolean(this.visible&&this.alpha>
...
this.outline;a.lineHeight=this.lineHeight;a.lineWidth=this.lineWidth};a._getWorkingContext=function(){var a=c._workingContext;a.font=this.font;a.textAlign=this.textAlign||"start";a.textBaseline=this.textBaseline||"alphabetic";return a};a._drawText=function(a){var c=!!a;c||(a=this._getWorkingContext());for(var h=String(this.text).split(/(?:\r\n|\r|\n)/),e=this.lineHeight||this.getMeasuredLineHeight(),d=0,f=0,g=h.length;f<g;f++){var l=a.measureText(h[f]).width;if(this.lineWidth==null||l<this.lineWidth)c&&
this._drawTextLine(a,h[f],d*e);else{for(var l=h[f].split(/(\s)/),j=l[0],k=1,i=l.length;k<i;k+=2)a.measureText(j+l[k]+l[k+1]).width>this.lineWidth?(c&&this._drawTextLine(a,j,d*e),d++,j=l[k+1]):j+=l[k]+l[k+1];c&&this._drawTextLine(a,j,d*e)}d++}return d};a._drawTextLine=function(a,c,h){this.outline?a.strokeText(c,0,h,this.maxWidth||65535):a.fillText(c,0,h,this.maxWidth||65535)};i.Text=c})(window);(function(i){var c=function(){throw"SpriteSheetUtils cannot be instantiated";};c._workingCanvas=document.createElement("canvas");c._workingContext=c._workingCanvas.getContext("2d");c.addFlippedFrames=function(a,b,i,h){if(b||i||h){var e=0;b&&c._flip(a,++e,true,false);i&&c._flip(a,++e,false,true);h&&c._flip(a,++e,true,true)}};c.extractFrame=function(a,b){isNaN(b)&&(b=a.getAnimation(b).frames[0]);var i=a.getFrame(b);if(!i)return null;var h=i.rect,e=c._workingCanvas;e.width=h.width;e.height=h.height;
c._workingContext.drawImage(i.image,h.x,h.y,h.width,h.height,0,0,h.width,h.height);i=new Image;i.src=e.toDataURL("image/png");return i};c._flip=function(a,b,i,h){for(var e=a._images,d=c._workingCanvas,f=c._workingContext,g=e.length/b,l=0;l<g;l++){var j=e[l];j.__tmp=l;d.width=j.width;d.height=j.height;f.setTransform(i?-1:1,0,0,h?-1:1,i?j.width:0,h?j.height:0);f.drawImage(j,0,0);var k=new Image;k.src=d.toDataURL("image/png");k.width=j.width;k.height=j.height;e.push(k)}f=a._frames;d=f.length/b;for(l=
0;l<d;l++){var j=f[l],o=j.rect.clone(),k=e[j.image.__tmp+g*b],m={image:k,rect:o,regX:j.regX,regY:j.regY};if(i)o.x=k.width-o.x-o.width,m.regX=o.width-j.regX;if(h)o.y=k.height-o.y-o.height,m.regY=o.height-j.regY;f.push(m)}i="_"+(i?"h":"")+(h?"v":"");h=a._animations;a=a._data;e=h.length/b;for(l=0;l<e;l++){f=h[l];j=a[f];g={name:f+i,frequency:j.frequency,next:j.next,frames:[]};j.next&&(g.next+=i);f=j.frames;j=0;for(k=f.length;j<k;j++)g.frames.push(f[j]+d*b);a[g.name]=g;h.push(g.name)}};i.SpriteSheetUtils=
...
a._handleTouchMoveListener=null};c._findPrimaryTouch=function(a,b){for(var c=b.length,h=0;h<c;h++){var e=b[h];if(e.identifier==a._primaryTouchId)return e}return null};i.Touch=c})(window);
