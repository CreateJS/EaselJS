...
(function(){function c(a,b){this.f=a;this.priority=b}var b=function(){this.initialize()},a=b.prototype;b.initialize=function(m){m.addEventListener=a.addEventListener;m.removeEventListener=a.removeEventListener;m.removeAllEventListeners=a.removeAllEventListeners;m.hasEventListener=a.hasEventListener;m.dispatchEvent=a.dispatchEvent};a._listeners=null;a.initialize=function(){};a.addEventListener=function(a,b,d){d=d||0;var e=new c(b,d),f=this._listeners;f||(f=this._listeners={});var g=f[a];if(g){this.removeEventListener(a,
b);a=0;for(b=g.length;a<b&&g[a].priority>=d;a++);g.splice(a,0,e)}else f[a]=[e]};a.removeEventListener=function(a,b){var d=this._listeners;if(d){var e=d[a];if(e)for(var c=0,g=e.length;c<g;c++)if(e[c].f==b){1==g?delete d[a]:e.splice(c,1);break}}};a.removeAllEventListeners=function(a){a?this._listeners&&delete this._listeners[a]:this._listeners=null};a.dispatchEvent=function(a,b){var d,e=this._listeners;if(a&&e){"string"==typeof a&&(a={type:a});a.target=b||this;e=e[a.type];if(!e)return!!d;for(var c=
0,g=e.length;c<g;c++){var j=e[c];d=d||j.f.apply(null,[a])}}return!!d};a.hasEventListener=function(a){var b=this._listeners;return!(!b||!b[a])};a.toString=function(){return"[EventDispatcher]"};createjs.EventDispatcher=b})();this.createjs=this.createjs||{};
...
(function(){var c=function(a,b,h,d,c,f,g){this.initialize(a,b,h,d,c,f,g)},b=c.prototype;b.target=null;b.overLabel=null;b.outLabel=null;b.pressLabel=null;b.play=!1;b._isPressed=!1;b.initialize=function(a,b,h,d,c,f,g){if(a.addEventListener){this.target=a;this.overLabel=null==h?"over":h;this.outLabel=null==b?"out":b;this.pressLabel=null==d?"press":d;this.play=c;a.cursor="pointer";var j=this;this._f=function(a){j._handleEvt(a)};this.setEnabled(!0);this._handleEvt({});f&&(g&&(f.actionsEnabled=!1,f.gotoAndStop(g)),
a.hitArea=f)}};b.setEnabled=function(a){var b=this.target,h=this._f;a?(b.addEventListener("mouseOver",h),b.addEventListener("mouseOut",h),b.addEventListener("press",h),b.addEventListener("click",h)):(b.removeEventListener("mouseOver",h),b.removeEventListener("mouseOut",h),b.removeEventListener("press",h),b.removeEventListener("click",h))};b.toString=function(){return"[ButtonHelper]"};b._handleEvt=function(a){var b="mouseOver"==a.type&&!this._isPressed||"click"==a.type?this.overLabel:"mouseOver"==
a.type&&this._isPressed||"press"==a.type?this.pressLabel:this.outLabel;if("press"==a.type)this._isPressed=!0,a.addEventListener("mouseUp",this._f);else if("mouseUp"==a.type){this._isPressed=!1;return}this.play?this.target.gotoAndPlay(b):this.target.gotoAndStop(b)};createjs.ButtonHelper=c})();this.createjs=this.createjs||{};(function(){var c=function(a,b,h,d){this.initialize(a,b,h,d)},b=c.prototype;c.identity=null;b.color=null;b.offsetX=0;b.offsetY=0;b.blur=0;b.initialize=function(a,b,h,d){this.color=a;this.offsetX=b;this.offsetY=h;this.blur=d};b.toString=function(){return"[Shadow]"};b.clone=function(){return new c(this.color,this.offsetX,this.offsetY,this.blur)};c.identity=new c("transparent",0,0,0);createjs.Shadow=c})();this.createjs=this.createjs||{};
...
["strokeStyle",d],!1)];return this};a.endStroke=function(){this.beginStroke();return this};a.curveTo=a.quadraticCurveTo;a.drawRect=a.rect;a.drawRoundRect=function(a,b,c,e,f){this.drawRoundRectComplex(a,b,c,e,f,f,f,f);return this};a.drawRoundRectComplex=function(a,b,d,e,f,g,j,k){var l=(d<e?d:e)/2,n=0,p=0,q=0,s=0;0>f&&(f*=n=-1);f>l&&(f=l);0>g&&(g*=p=-1);g>l&&(g=l);0>j&&(j*=q=-1);j>l&&(j=l);0>k&&(k*=s=-1);k>l&&(k=l);this._dirty=this._active=!0;var l=this._ctx.arcTo,r=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,
[a+d-g,b]),new c(l,[a+d+g*p,b-g*p,a+d,b+g,g]),new c(r,[a+d,b+e-j]),new c(l,[a+d+j*q,b+e+j*q,a+d-j,b+e,j]),new c(r,[a+k,b+e]),new c(l,[a-k*s,b+e+k*s,a,b+e-k,k]),new c(r,[a,b+f]),new c(l,[a-f*n,b-f*n,a+f,b,f]),new c(this._ctx.closePath));return this};a.drawCircle=function(a,b,c){this.arc(a,b,c,0,2*Math.PI);return this};a.drawEllipse=function(a,b,d,e){this._dirty=this._active=!0;var f=0.5522848*(d/2),g=0.5522848*(e/2),j=a+d,k=b+e;d=a+d/2;e=b+e/2;this._activeInstructions.push(new c(this._ctx.moveTo,[a,
...
this.canvas.height)}};b.toDataURL=function(a,b){b||(b="image/png");var c=this.canvas.getContext("2d"),d=this.canvas.width,e=this.canvas.height,f;if(a){f=c.getImageData(0,0,d,e);var g=c.globalCompositeOperation;c.globalCompositeOperation="destination-over";c.fillStyle=a;c.fillRect(0,0,d,e)}var j=this.canvas.toDataURL(b);a&&(c.clearRect(0,0,d,e),c.putImageData(f,0,0),c.globalCompositeOperation=g);return j};b.enableMouseOver=function(a){this._mouseOverIntervalID&&(clearInterval(this._mouseOverIntervalID),
...
f=e.inBounds;this._updatePointerPosition(a,c,d);if(f||e.inBounds||this.mouseMoveOutside)if(a=new createjs.MouseEvent("mouseMove",e.x,e.y,this,b,a,a==this._primaryPointerID,e.rawX,e.rawY),this.onMouseMove&&this.onMouseMove(a),this.dispatchEvent(a),(e=e.event)&&(e.onMouseMove||e.hasEventListener("mouseMove")))a=a.clone(),a.target=e.target,e.onMouseMove&&e.onMouseMove(a),e.dispatchEvent(a,e.target)}};b._updatePointerPosition=function(a,b,c){var d=this._getElementRect(this.canvas);b-=d.left;c-=d.top;
var e=this.canvas.width,f=this.canvas.height;b/=(d.right-d.left)/e;c/=(d.bottom-d.top)/f;d=this._getPointerData(a);(d.inBounds=0<=b&&0<=c&&b<=e-1&&c<=f-1)?(d.x=b,d.y=c):this.mouseMoveOutside&&(d.x=0>b?0:b>e-1?e-1:b,d.y=0>c?0:c>f-1?f-1:c);d.rawX=b;d.rawY=c;a==this._primaryPointerID&&(this.mouseX=d.x,this.mouseY=d.y,this.mouseInBounds=d.inBounds)};b._getElementRect=function(a){var b=a.getBoundingClientRect(),c=(window.pageXOffset||document.scrollLeft||0)-(document.clientLeft||document.body.clientLeft||
...
a,!1)};b._handlePointerUp=function(a,b,c){var d=this._getPointerData(a),e=new createjs.MouseEvent("mouseUp",d.x,d.y,this,b,a,a==this._primaryPointerID,d.rawX,d.rawY);this.onMouseUp&&this.onMouseUp(e);this.dispatchEvent(e);var f=d.event;f&&(e=e.clone(),e.target=f.target,f.onMouseUp&&f.onMouseUp(e),f.dispatchEvent(e,f.target));if((f=d.target)&&(f.onClick||f.hasEventListener("click"))&&this._getObjectsUnderPoint(d.x,d.y,null,!0,this._mouseOverIntervalID?3:1)==f)e=new createjs.MouseEvent("click",d.x,
d.y,f,b,a,a==this._primaryPointerID,d.rawX,d.rawY),f.onClick&&f.onClick(e),f.dispatchEvent(e);c?(a==this._primaryPointerID&&(this._primaryPointerID=null),delete this._pointerData[a]):d.event=d.target=null};b._handleMouseDown=function(a){this._handlePointerDown(-1,a,!1)};b._handlePointerDown=function(a,b,c,d){var e=this._getPointerData(a);null!=d&&this._updatePointerPosition(a,c,d);if(this.onMouseDown||this.hasEventListener("mouseDown"))c=new createjs.MouseEvent("mouseDown",e.x,e.y,this,b,a,a==this._primaryPointerID,
e.rawX,e.rawY),this.onMouseDown&&this.onMouseDown(c),this.dispatchEvent(c);if(d=this._getObjectsUnderPoint(e.x,e.y,null,this._mouseOverIntervalID?3:1)){if(d.onPress||d.hasEventListener("press"))if(c=new createjs.MouseEvent("press",e.x,e.y,d,b,a,a==this._primaryPointerID,e.rawX,e.rawY),d.onPress&&d.onPress(c),d.dispatchEvent(c),c.onMouseMove||c.onMouseUp||c.hasEventListener("mouseMove")||c.hasEventListener("mouseUp"))e.event=c;e.target=d}};b._testMouseOver=function(){if(-1==this._primaryPointerID&&
...
"");if(a&&(a.onMouseOver||a.hasEventListener("mouseOver")))d=new createjs.MouseEvent("mouseOver",c.x,c.y,a,null,-1,c.rawX,c.rawY),a.onMouseOver&&a.onMouseOver(d),a.dispatchEvent(d);a&&(this.canvas.style.cursor=a.cursor||"");this._mouseOverTarget=a}}};b._handleDoubleClick=function(a){var b=this._getPointerData(-1),c=this._getObjectsUnderPoint(b.x,b.y,null,this._mouseOverIntervalID?3:1);if(c&&(c.onDoubleClick||c.hasEventListener("doubleClick")))evt=new createjs.MouseEvent("doubleClick",b.x,b.y,c,a,
-1,!0,b.rawX,b.rawY),c.onDoubleClick&&c.onDoubleClick(evt),c.dispatchEvent(evt)};createjs.Stage=c})();this.createjs=this.createjs||{};
...
this.name+")]"};b.DisplayObject__tick=b._tick;b._tick=function(a){var b=this._animation?this._animation.frequency:1;!this.paused&&0==(++this._advanceCount+this.offset)%b&&this.advance();this.DisplayObject__tick(a)};b._normalizeFrame=function(){var a=this._animation,b=this.currentFrame,c=this.paused;if(a)if(this.currentAnimationFrame>=a.frames.length){var d=a.next;this._dispatchAnimationEnd(a,b,c,d)||(d?this._goto(d):(this.paused=!0,this.currentAnimationFrame=a.frames.length-1,this.currentFrame=a.frames[this.currentAnimationFrame]))}else this.currentFrame=
a.frames[this.currentAnimationFrame];else b>=this.spriteSheet.getNumFrames()&&!this._dispatchAnimationEnd(a,b,c)&&(this.currentFrame=0)};b._dispatchAnimationEnd=function(a,b,c,d){var e=a?a.name:null;this.onAnimationEnd&&this.onAnimationEnd(this,e,d);this.dispatchEvent({type:"animationEnd",name:e,next:d});return this.paused!=c||this._animation!=a||this.currentFrame!=b};b.DisplayObject_cloneProps=b.cloneProps;b.cloneProps=function(a){this.DisplayObject_cloneProps(a);a.onAnimationEnd=this.onAnimationEnd;
...
function(){};b.uncache=function(){};b.updateCache=function(){};b.hitTest=function(){};b.localToGlobal=function(){};b.globalToLocal=function(){};b.localToLocal=function(){};b.clone=function(){var a=new c;this.cloneProps(a);return a};b.toString=function(){return"[DOMElement (name="+this.name+")]"};b._tick=function(a){if(null!=this.htmlElement&&(this.htmlElement.style.visibility="hidden",this.onTick))this.onTick(a)};createjs.DOMElement=c})();this.createjs=this.createjs||{};(function(){var c=function(){this.initialize()},b=c.prototype;b.initialize=function(){};b.getBounds=function(){return new createjs.Rectangle(0,0,0,0)};b.applyFilter=function(){};b.toString=function(){return"[Filter]"};b.clone=function(){return new c};createjs.Filter=c})();this.createjs=this.createjs||{};
...
b._handlePointerMove(a,c,h,d)};c._handleEnd=function(b,a,c){var h=b.__touch,d=h.pointers;d[a]&&(h.count--,b._handlePointerUp(a,c,!0),delete d[a])};createjs.Touch=c})();(function(){var c=this.createjs=this.createjs||{},c=c.EaselJS=c.EaselJS||{};c.version="NEXT";c.buildDate="Wed, 09 Jan 2013 22:06:06 GMT"})();
