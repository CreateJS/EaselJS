...
function(){this.beginStroke();return this};a.curveTo=a.quadraticCurveTo;a.drawRect=a.rect;a.drawRoundRect=function(a,b,d,c,f){this.drawRoundRectComplex(a,b,d,c,f,f,f,f);return this};a.drawRoundRectComplex=function(a,b,d,e,f,g,i,j){var k=(d<e?d:e)/2,m=0,o=0,n=0,q=0;f<0&&(f*=m=-1);f>k&&(f=k);g<0&&(g*=o=-1);g>k&&(g=k);i<0&&(i*=n=-1);i>k&&(i=k);j<0&&(j*=q=-1);j>k&&(j=k);this._dirty=this._active=true;var k=this._ctx.arcTo,p=this._ctx.lineTo;this._activeInstructions.push(new c(this._ctx.moveTo,[a+d-g,b]),
...
0,f.width=1,this;for(var j=this.children.length-1;j>=0;j--){var k=this.children[j];if(k.isVisible()&&k.mouseEnabled)if(k instanceof c)if(i){if(k=k._getObjectsUnderPoint(a,b))return this}else{if(k=k._getObjectsUnderPoint(a,b,h,d),!h&&k)return k}else if(!d||i||k._hasMouseHandler(d)){var m=k.hitArea;k.getConcatenatedMatrix(g);m&&(g.appendTransform(m.x+k.regX,m.y+k.regY,m.scaleX,m.scaleY,m.rotation,m.skewX,m.skewY,m.regX,m.regY),g.alpha*=m.alpha/k.alpha);e.globalAlpha=g.alpha;e.setTransform(g.a,g.b,g.c,
g.d,g.tx-a,g.ty-b);(m||k).draw(e);if(this._testHit(e))if(f.width=0,f.width=1,i)return this;else if(h)h.push(k);else return k}}return null};createjs.Container=c})();this.createjs=this.createjs||{};
...
d.dispatchEvent(c),c.onMouseMove||c.onMouseUp||c._listeners&&(c.hasEventListener("mouseMove")||c.hasEventListener("mouseUp")))e.event=c;e.target=d}};b._testMouseOver=function(){if(this._primaryPointerID==-1&&!(this.mouseX==this._mouseOverX&&this.mouseY==this._mouseOverY&&this.mouseInBounds)){var a=null;if(this.mouseInBounds)a=this._getObjectsUnderPoint(this.mouseX,this.mouseY,null,3),this._mouseOverX=this.mouseX,this._mouseOverY=this.mouseY;var b=this._mouseOverTarget;if(b!=a){if(b&&(b.onMouseOut||
b._listeners&&b.hasEventListener("mouseOut"))){var c=new createjs.MouseEvent("mouseOut",this.mouseX,this.mouseY,b);b.onMouseOut&&b.onMouseOut(c);b._listeners&&b.dispatchEvent(c)}if(b)this.canvas.style.cursor="";if(a&&(a.onMouseOver||a._listeners&&a.hasEventListener("mouseOver")))c=new createjs.MouseEvent("mouseOver",this.mouseX,this.mouseY,a),a.onMouseOver&&a.onMouseOver(c),a._listeners&&a.dispatchEvent(c);if(a)this.canvas.style.cursor=a.cursor||"";this._mouseOverTarget=a}}};b._handleDoubleClick=
function(a){if(this.hasEventListener("doubleClick",this.onDoubleClick)){var b=new createjs.MouseEvent("doubleClick",this.mouseX,this.mouseY,this,a,-1,true);this.dispatchEvent(b,this.onDoubleClick,[b])}var c=this._getObjectsUnderPoint(this.mouseX,this.mouseY,null,this._mouseOverIntervalID?3:1);c&&c.hasEventListener("doubleClick",c.onDoubleClick)&&(b=new createjs.MouseEvent("doubleClick",this.mouseX,this.mouseY,c,a,-1,true),c.dispatchEvent(b,c.onDoubleClick,[b]))};createjs.Stage=c})();this.createjs=this.createjs||{};
